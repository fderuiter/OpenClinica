...
public class RuleDAO extends AuditableEntityDAO {
    ...
    @Autowired
    public RuleDAO(DataSource ds, CRFVersionDAO _cRFVersionDAO, EventCRFDAO _eventCRFDAO, ExpressionDAO _expressionDAO, ItemDataDAO _itemDataDAO, RuleSetDAO _ruleSetDAO, StudyEventDefinitionDAO _studyEventDefinitionDAO) {
        super(ds);
