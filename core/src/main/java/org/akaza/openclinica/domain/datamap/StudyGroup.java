...
@GenericGenerator(name = "id-generator", strategy = "native", parameters = { @Parameter(name = "sequence", value = "study_group_study_group_id_seq"), @Parameter(name = "increment_size", value = "1") })
