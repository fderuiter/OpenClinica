...
@Entity
@Table(name = "section")
@GenericGenerator(name = "id-generator", strategy = "native", parameters = { @Parameter(name = "sequence", value = "section_section_id_seq"), @Parameter(name = "increment_size", value = "1") })
