...
@GenericGenerator(name = "id-generator", strategy = "native", parameters = { @Parameter(name = "sequence", value = "response_set_response_set_id_seq"), @Parameter(name = "increment_size", value = "1") })
