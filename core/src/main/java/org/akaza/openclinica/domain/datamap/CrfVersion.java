...
@GenericGenerator(name = "id-generator", strategy = "native", parameters = { @Parameter(name = "sequence", value = "crf_version_crf_version_id_seq"), @Parameter(name = "increment_size", value = "1") })
