...
@GenericGenerator(name = "id-generator", strategy = "native", parameters = { @Parameter(name = "sequence", value = "user_type_user_type_id_seq"), @Parameter(name = "increment_size", value = "1") })
