...
@GenericGenerator(name = "id-generator", strategy = "native", parameters = { @Parameter(name = "sequence", value = "study_parameter_study_parameter_id_seq"), @Parameter(name = "increment_size", value = "1") })
