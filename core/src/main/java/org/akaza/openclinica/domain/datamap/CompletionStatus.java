...
@GenericGenerator(name = "id-generator", strategy = "native", parameters = { @Parameter(name = "sequence", value = "completion_status_completion_status_id_seq"), @Parameter(name = "increment_size", value = "1") })
