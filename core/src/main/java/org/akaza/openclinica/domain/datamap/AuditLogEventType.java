...
@GenericGenerator(name = "id-generator", strategy = "native", parameters = { @Parameter(name = "sequence", value = "audit_log_event_type_audit_log_event_type_id_seq"), @Parameter(name = "increment_size", value = "1") })
