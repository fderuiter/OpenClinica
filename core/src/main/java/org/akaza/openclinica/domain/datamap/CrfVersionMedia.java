...
@GenericGenerator(name = "id-generator", strategy = "native", parameters = { @Parameter(name = "sequence", value = "crf_version_media_crf_version_media_id_seq"), @Parameter(name = "increment_size", value = "1") })
