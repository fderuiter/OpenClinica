...
@GenericGenerator(name = "id-generator", strategy = "native", parameters = { @Parameter(name = "sequence", value = "item_data_type_item_data_type_id_seq"), @Parameter(name = "increment_size", value = "1") })
