...
public class MetadataUnit extends OdmUnit {
    ...
    public MetadataUnit(DataSource ds, StudyBean study, int category) {
        ...
        if (study.getParentStudyId() > 0) {
            this.parentStudy = (StudyBean) org.akaza.openclinica.core.ApplicationContextProvider.getApplicationContext().getBean(StudyDAO.class).findByPK(study.getParentStudyId());
        } else {
    ...
    private void collectBasicDefinitions() {
        ...
        org.akaza.openclinica.core.ApplicationContextProvider.getApplicationContext().getBean(OdmExtractDAO.class).getBasicDefinitions(studyid, odmStudy.getBasicDefinitions());
    }
    
    
    private void collectBasicDefinitions(String formVersionOID){
    	org.akaza.openclinica.core.ApplicationContextProvider.getApplicationContext().getBean(OdmExtractDAO.class).getBasicDefinitions(formVersionOID, odmStudy.getBasicDefinitions());
    }
    /**
