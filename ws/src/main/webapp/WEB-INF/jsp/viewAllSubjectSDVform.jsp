        ...
        <tr>
            <td valign="bottom" id="Tab1'">
               <%-- <div id="Tab1Selected"><div class="tab_BG"><div class="tab_L"><div class="tab_R">
                    <a class="tabtext" title="View By Study Subject Id" href='viewSubjectSDV?studyId=${studyId}&studySubjectId=${studySubjectId}&decorator=mydecorator' onclick="javascript:HighlightTab(1);">View By Study Subject Id</a></div></div></div></div>
            ...
            <td valign="bottom" id="Tab2'">
                <div id="Tab2NotSelected"><div class="tab_BG"><div class="tab_L"><div class="tab_R">
                    <a class="tabtext" title="View By Event CRF" href='viewAllSubjectSDV?studyId=${studyId}' onclick="javascript:HighlightTab(2);">View By Event CRF</a></div></div></div></div>
...
<div id="subjectSDV">
    <form name='sdvForm' action="${pageContext.request.contextPath}/pages/viewAllSubjectSDVform">
       ...
       <%--This value will be set by an onclick handler associated with an SDV button --%>
        ...
        <input type="submit" name="sdvAllFormCancel" class="button_medium" value="Cancel" onclick="this.form.action='${pageContext.request.contextPath}/pages/viewAllSubjectSDV';this.form.submit();"/>
    </form>
