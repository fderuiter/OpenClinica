...
function CalendarPopup() {
  ...
  c.monthAbbreviations = new Array(
    'Jan',
    'Feb',
    'Mar',
    'Apr',
...
function getCalendarStyles() {
  ...
  if (
    this != null &&
    typeof this.cssPrefix != 'undefined' &&
    this.cssPrefix != null &&
    this.cssPrefix != ''
  ) {
    p = this.cssPrefix;
  ...
  if (this.displayType == 'date' || this.displayType == 'week-end') {
    ...
    if (this.isShowNavigationDropdowns) {
      ...
      result +=
        ...
        month +
        ',this.options[this.selectedIndex].value-0);">';
      //Previous: for( var yearCounter=year-this.yearSelectStartOffset; yearCounter<=year+this.yearSelectStartOffset; yearCounter++ ) {
      //changes made for mantis issue 2304
      for (
