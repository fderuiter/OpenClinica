...
var tt_aElt = new Array(10), // Container DIV, outer title & body DIVs, inner title & body TDs, closebutton SPAN, shadow DIVs, and IFRAME to cover windowed elements in IE
  ...
  tt_t2t,
  tt_t2tDad, // Tag converted to tip, and its DOM parent element
  tt_musX,
  tt_musY,
  tt_over,
  tt_x,
  tt_y,
  tt_w,
  tt_h; // Position, width and height of currently displayed tooltip
...
var tt_aExt = new Array(), // Array of extension objects
  ...
  tt_bJmpVert,
  tt_bJmpHorz, // Tip temporarily on other side of mouse
...
function tt_GetWndCliSiz(s) {
  ...
  if (typeof y == sN) {
    ...
    return (
      ...
      // ... quirks mode
      (db = document.body) && typeof (y2 = db[sC]) == sN && y2 && y2 <= y
        ? y2
        : // ... strict mode
  ...
  return (
    ...
    (db = document.documentElement) && (y = db[sC])
      ? y
