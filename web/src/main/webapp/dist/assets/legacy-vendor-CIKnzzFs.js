...
var require_prototype = __commonJSMin((exports, module) => {
    var Prototype = {
      Version: `1.7.3`,
      Browser: (function () {
      ...
      BrowserFeatures: {
        ...
        SpecificElementExtensions: (function () {
          if (window.HTMLDivElement !== void 0) return !0;
          var e = document.createElement(`div`),
            t = document.createElement(`form`),
            n = !1;
          return (
            e.__proto__ && e.__proto__ !== t.__proto__ && (n = !0),
            (e = t = null),
            n
          );
        })(),
    ...
    var Class = (function () {
      ...
      function n() {
        ...
        (Object.extend(r, Class.Methods),
          ...
          e &&
            ...
            (r.prototype = new t()),
            e.subclasses.push(r)));
        for (var i = 0, a = n.length; i < a; i++) r.addMethods(n[i]);
        return (
          r.prototype.initialize ||
            (r.prototype.initialize = Prototype.emptyFunction),
      ...
      function r(t) {
        var n = this.superclass && this.superclass.prototype,
          r = Object.keys(t);
        e &&
          (t.toString != Object.prototype.toString && r.push(`toString`),
          t.valueOf != Object.prototype.valueOf && r.push(`valueOf`));
        for (var i = 0, a = r.length; i < a; i++) {
          var o = r[i],
            s = t[o];
          if (n && Object.isFunction(s) && s.argumentNames()[0] == `$super`) {
            var c = s;
            ((s = (function (e) {
              return function () {
      ...
      return { create: n, Methods: { addMethods: r } };
    })();
    ((function () {
      var e = Object.prototype.toString,
        ...
        m =
          ...
          JSON.stringify(0) === `0` &&
          JSON.stringify(Prototype.K) === void 0,
        h = [
          `toString`,
          `toLocaleString`,
          `valueOf`,
      ...
      function x(t, n, r) {
        var i = n[t];
        _(i) === s && typeof i.toJSON == `function` && (i = i.toJSON(t));
        var a = e.call(i);
        switch (a) {
          case u:
          case l:
        ...
        switch (typeof i) {
          ...
          case `object`:
            for (var o = 0, c = r.length; o < c; o++)
              if (r[o] === i)
                throw TypeError(`Cyclic reference to '` + i + `' in object`);
            r.push(i);
            var p = [];
            if (a === f) {
              for (var o = 0, c = i.length; o < c; o++) {
                var m = x(o, i, r);
                p.push(m === void 0 ? `null` : m);
              }
              p = `[` + p.join(`,`) + `]`;
            } else {
              for (var h = Object.keys(i), o = 0, c = h.length; o < c; o++) {
                var t = h[o],
                  m = x(t, i, r);
                m !== void 0 && p.push(t.inspect(!0) + `:` + m);
              }
              p = `{` + p.join(`,`) + `}`;
            }
            return (r.pop(), p);
      ...
      function T(e) {
        if (_(e) !== s) throw TypeError();
        var n = [];
        for (var r in e) t.call(e, r) && n.push(r);
        if (g) for (var i = 0; (r = h[i]); i++) t.call(e, r) && n.push(r);
        return n;
      }
      function E(e) {
        var t = [];
        ...
        (function () {
          ...
          function i(t) {
            ...
            if (!Object.isFunction(this))
              throw TypeError(`The object is not callable.`);
            var r = function () {},
              i = this,
              a = e.call(arguments, 1),
              o = function () {
                var e = n(a, arguments),
                  r = this instanceof o ? this : t;
                return i.apply(r, e);
              };
          ...
          return (Function.prototype.bind || (d.bind = i), d);
        })()
      ),
      (function (e) {
        function t() {
        ...
        (function () {
          ...
          function gsub(e, t) {
            var n = ``,
              ...
              i;
            if (
              ((t = prepareReplacement(t)),
              Object.isString(e) && (e = RegExp.escape(e)),
            ...
            return t
              ? t[1].split(e || `&`).inject({}, function (e, t) {
                  if ((t = t.split(`=`))[0]) {
                    ...
                    (r != null &&
                      ((r = r.gsub(`+`, ` `)), (r = decodeURIComponent(r))),
                      n in e
                        ? (Object.isArray(e[n]) || (e[n] = [e[n]]),
                          e[n].push(r))
                        : (e[n] = r));
                  }
                  return e;
          ...
          function inspect(e) {
            var t = this.replace(/[\x00-\x1f\\]/g, function (e) {
              return e in String.specialChar
                ? String.specialChar[e]
                : `\\u00` + e.charCodeAt().toPaddedString(2, 16);
            });
            return e
              ? `"` + t.replace(/"/g, `\\"`) + `"`
              : `'` + t.replace(/'/g, `\\'`) + `'`;
          ...
          function startsWith(e, t) {
            return (
              (t = Object.isNumber(t) ? t : 0),
              this.lastIndexOf(e, t) === t
            );
          }
          function endsWith(e, t) {
            ((e = String(e)),
              (t = Object.isNumber(t) ? t : this.length),
              t < 0 && (t = 0),
    ...
    var Template = Class.create({
      ...
      evaluate: function (e) {
        return (
          e &&
            Object.isFunction(e.toTemplateReplacements) &&
            (e = e.toTemplateReplacements()),
          this.template.gsub(this.pattern, function (t) {
            if (e == null) return t[1] + ``;
            var n = t[1] || ``;
            if (n == `\\`) return t[2];
            var r = e,
              i = t[3],
    ...
    var $break = {},
      Enumerable = (function () {
        ...
        function n(e, t) {
          ...
          return (
            this.each(function (r, i) {
              if (((n &&= !!e.call(t, r, i, this)), !n)) throw $break;
            }, this),
            n
          );
        }
        function r(e, t) {
          ...
          return (
            this.each(function (r, i) {
              if ((n = !!e.call(t, r, i, this))) throw $break;
            }, this),
            n
          );
        }
        ...
        function a(e, t) {
          ...
          return (
            this.each(function (r, i) {
              if (e.call(t, r, i, this)) throw ((n = r), $break);
            }, this),
            n
          );
        }
        ...
        function s(e, t, n) {
          ...
          return (
            ...
            this.each(function (i, a) {
              e.match(i) && r.push(t.call(n, i, a, this));
            }, this),
            r
          );
        }
        function c(e) {
          if (Object.isFunction(this.indexOf) && this.indexOf(e) != -1)
            return !0;
          var t = !1;
          return (
        ...
        function f(e, t) {
          ...
          return (
            this.each(function (r, i) {
              ((r = e.call(t, r, i, this)), (n == null || r >= n) && (n = r));
            }, this),
            n
          );
        }
        ...
        function _(e, t) {
          return this.map(function (n, r) {
            return { value: n, criteria: e.call(t, n, r, this) };
          }, this)
            .sort(function (e, t) {
              var n = e.criteria,
                r = t.criteria;
    ...
    function $w(e) {
      return Object.isString(e)
        ? ((e = e.strip()), e ? e.split(/\s+/) : [])
        : [];
    }
    ((Array.from = $A),
      (function () {
        ...
        function d(e) {
          return this.inject([], function (t, n, r) {
            return (
              (r == 0 || (e ? t.last() != n : !t.include(n))) && t.push(n),
              t
            );
          });
        }
        ...
        function g(e, t) {
          ...
          if (
            ...
            isNaN(t)
              ...
              : t !== 0 &&
                isFinite(t) &&
                (t = (t > 0 ? 1 : -1) * Math.floor(Math.abs(t))),
            t > r)
          )
            return -1;
          for (var i = t >= 0 ? t : Math.max(r - Math.abs(t), 0); i < r; i++)
            ...
            : ((t = Number(t)),
              isNaN(t)
                ...
                : t !== 0 &&
                  ...
                  (t = (t > 0 ? 1 : -1) * Math.floor(Math.abs(t))));
          for (
            var i = t >= 0 ? Math.min(t, r - 1) : r - Math.abs(t);
            i >= 0;
            i--
          )
            if (i in n && n[i] === e) return i;
        ...
        function v(e) {
          ...
          for (var o = 0, s = r.length; o < s; o++)
            if (((i = r[o]), Object.isArray(i) && !(`callee` in i)))
        ...
        function y(e) {
          return function () {
            if (arguments.length === 0) return e.call(this, Prototype.K);
            if (arguments[0] === void 0) {
              var n = t.call(arguments, 1);
              return (n.unshift(Prototype.K), e.apply(this, n));
        ...
        function b(e) {
          ...
          for (
            ...
            (a in t && (n[i] = e.call(r, t[a], a, t)), i++);
          return ((n.length = i), n);
        }
        e.map && (b = y(Array.prototype.map));
        function x(e) {
          if (this == null || !Object.isFunction(e)) throw TypeError();
          for (
            var t = Object(this),
              n = [],
              r = arguments[1],
            ...
            a in t && ((i = t[a]), e.call(r, i, a, t) && n.push(i));
          return n;
        }
        e.filter && (x = Array.prototype.filter);
        function S(e) {
          if (this == null) throw TypeError();
          e ||= Prototype.K;
          for (
            var t = arguments[1], n = Object(this), r = 0, i = n.length >>> 0;
            r < i;
            r++
          )
            if (r in n && e.call(t, n[r], r, n)) return !0;
          return !1;
        }
        e.some && (S = y(Array.prototype.some));
        function C(e) {
          if (this == null) throw TypeError();
          e ||= Prototype.K;
          for (
            ...
            if (r in n && !e.call(t, n[r], r, n)) return !1;
          return !0;
        }
        (e.every && (C = y(Array.prototype.every)),
          Object.extend(e, Enumerable),
          e.entries === Enumerable.entries && delete e.entries,
          (e._reverse ||= e.reverse),
          Object.extend(e, {
            _each: n,
            map: b,
            collect: b,
      ...
      (function () {
        ...
        function t(e, t) {
          ...
          for (var r in this._object) {
            var i = this._object[r],
              a = [r, i];
            ((a.key = r), (a.value = i), e.call(t, a, n), n++);
          }
        }
        function n(e, t) {
        ...
        function f() {
          return this.inject([], function (e, t) {
            ...
            if (r && typeof r == `object`) {
              if (Object.isArray(r)) {
                for (var i = [], a = 0, o = r.length, s; a < o; a++)
                  ((s = r[a]), i.push(d(n, s)));
                return e.concat(i);
              }
            } else e.push(d(n, r));
    ...
    var ObjectRange = Class.create(
        ...
        (function () {
          ...
          function t(e, t) {
            var n = this.start,
              r;
            for (r = 0; this.include(n); r++) (e.call(t, n, r), (n = n.succ()));
          }
          function n(e) {
            return e < this.start
              ? !1
    ...
    ((Ajax.Responders = {
      ...
      (Ajax.Request = Class.create(Ajax.Base, {
        ...
        request: function (e) {
          ...
          var t = Object.isString(this.options.parameters)
            ? this.options.parameters
            : Object.toQueryString(this.options.parameters);
          ([`get`, `post`].include(this.method) ||
            ((t += (t ? `&` : ``) + `_method=` + this.method),
            (this.method = `post`)),
            t &&
              this.method === `get` &&
              (this.url += (this.url.include(`?`) ? `&` : `?`) + t),
          ...
          try {
            ...
            (this.options.onCreate && this.options.onCreate(n),
              ...
              (this.body =
                this.method == `post` ? this.options.postBody || t : null),
        ...
        setRequestHeaders: function () {
            ...
            (this.method == `post` &&
              ...
              this.transport.overrideMimeType &&
                (navigator.userAgent.match(/Gecko\/(\d{4})/) || [0, 2005])[1] <
                  2005 &&
                (e.Connection = `close`)),
            typeof this.options.requestHeaders == `object`)
          ) {
            var t = this.options.requestHeaders;
            if (Object.isFunction(t.push))
              for (var n = 0, r = t.length; n < r; n += 2) e[t[n]] = t[n + 1];
            else
              $H(t).each(function (t) {
                e[t.key] = t.value;
              });
          ...
          for (var i in e)
            e[i] != null && this.transport.setRequestHeader(i, e[i]);
        },
        success: function () {
        ...
        getStatus: function () {
          try {
            return this.transport.status === 1223
              ? 204
        ...
        respondToReadyState: function (e) {
          ...
          try {
            ((this.options[`on` + t] || Prototype.emptyFunction)(
              n,
              n.headerJSON
            ),
      ...
      (Ajax.Response = Class.create({
        initialize: function (e) {
          ...
          if (
            ...
            var r = t.responseXML;
            ((this.responseXML = Object.isUndefined(r) ? null : r),
        ...
        _getResponseJSON: function () {
          ...
          try {
            return this.responseText.evalJSON(
              e.sanitizeJSON || !this.request.isSameOrigin()
            );
          } catch (e) {
            this.request.dispatchException(e);
          }
      ...
      (function (e) {
        ...
        function i(e) {
          if (arguments.length > 1) {
            for (var t = 0, n = [], r = arguments.length; t < r; t++)
              n.push(i(arguments[t]));
            return n;
          }
          return (
            Object.isString(e) && (e = document.getElementById(e)),
            l.extend(e)
          );
        }
        ((e.$ = i),
        ...
        var s = (function () {
          ...
          c = e.Element;
        function l(e, t) {
          if (((t ||= {}), (e = e.toLowerCase()), s && t.name))
            return (
              (e = `<` + e + ` name="` + t.name + `">`),
              delete t.name,
              l.writeAttribute(document.createElement(e), t)
            );
          a[e] || (a[e] = l.extend(document.createElement(e)));
          var n = o(e, t) ? a[e].cloneNode(!1) : document.createElement(e);
          return l.writeAttribute(n, t);
        }
        ((e.Element = l),
          Object.extend(e.Element, c || {}),
          c && (e.Element.prototype = c.prototype),
          (l.Methods = { ByTag: {}, Simulated: {} }));
        var u = {},
          d = { id: `id`, className: `class` };
        function f(e) {
          e = i(e);
        ...
        u.inspect = f;
        function p(e) {
          return i(e).getStyle(`display`) !== `none`;
        }
        function m(e, t) {
          return (
            (e = i(e)),
            typeof t != `boolean` && (t = !l.visible(e)),
            l[t ? `show` : `hide`](e),
            e
          );
        }
        function h(e) {
          return ((e = i(e)), (e.style.display = `none`), e);
        }
        function g(e) {
          return ((e = i(e)), (e.style.display = ``), e);
        }
        Object.extend(u, { visible: p, toggle: m, hide: h, show: g });
        function _(e) {
          return ((e = i(e)), e.parentNode.removeChild(e), e);
        }
        var v = (function () {
            ...
            return (
              ...
              e.options &&
                e.options[0] &&
                (t = e.options[0].nodeName.toUpperCase() !== `OPTION`),
              (e = null),
              t
            );
          })(),
        ...
        function w(e, t) {
          if (((e = i(e)), t && t.toElement)) t = t.toElement();
        ...
        `outerHTML` in document.documentElement && (w = D);
        function O(e) {
          return Object.isUndefined(e) || e === null
            ? !1
            : !!(
                Object.isString(e) ||
                Object.isNumber(e) ||
        ...
        function k(e, t, n) {
          ...
          (n === `top` || n === `after`) && i.reverse();
          for (var a = 0, o; (o = i[a]); a++) r(e, o);
          t.evalScripts.bind(t).defer();
        }
        function A(e, t) {
          for (var n in ((e = i(e)), O(t) && (t = { bottom: t }), t))
            k(e, t[n], n);
          return e;
        }
        function ee(e, t, n) {
          return (
            (e = i(e)),
            Object.isElement(t)
              ? i(t).writeAttribute(n || {})
              : (t = Object.isString(t) ? new l(t, n) : new l(`div`, t)),
        ...
        function L(e, t, n) {
          ...
          for (
            var r = [];
            (e = e[t]) &&
            (e.nodeType === Node.ELEMENT_NODE && r.push(l.extend(e)),
            r.length !== n);
          );
          return r;
        }
        ...
        function ce(e, t, n, r) {
          for (
            e = i(e),
              n ||= 0,
              r ||= 0,
              Object.isNumber(n) && ((r = n), (n = null));
            (e = e[t]);
          )
            if (
              e.nodeType === 1 &&
              !(n && !Prototype.Selector.match(e, n)) &&
              !(--r >= 0)
            )
              return l.extend(e);
        }
        function le(e, t, n) {
          return (
            (e = i(e)),
            arguments.length === 1 ? i(e.parentNode) : ce(e, `parentNode`, t, n)
          );
        }
        function ue(e, t, n) {
          if (arguments.length === 1) return re(e);
          ((e = i(e)),
            (t ||= 0),
            (n ||= 0),
            Object.isNumber(t) && ((n = t), (t = `*`)));
          var r = Prototype.Selector.select(t, e)[n];
          return l.extend(r);
        }
        function z(e, t, n) {
          return ce(e, `previousSibling`, t, n);
        }
        function B(e, t, n) {
          return ce(e, `nextSibling`, t, n);
        }
        function de(e) {
          e = i(e);
          var t = n.call(arguments, 1).join(`, `);
        ...
        function fe(e) {
          ...
          for (
            ...
            Prototype.Selector.match(s, t) && a.push(s);
          return a;
        }
        function pe(e, t) {
        ...
        function me(e, t) {
          return (
            (e = i(e)),
            (t = i(t)),
            !e || !t ? !1 : t.contains ? t.contains(e) && t !== e : pe(e, t)
          );
        }
        function V(e, t) {
          return (
            (e = i(e)),
            (t = i(t)),
            !e || !t ? !1 : (e.compareDocumentPosition(t) & 8) == 8
          );
        }
        var H = r.compareDocumentPosition ? V : r.contains ? me : pe;
        Object.extend(u, {
          recursivelyCollect: L,
          ancestors: te,
          descendants: ne,
          firstDescendant: re,
          immediateDescendants: ie,
          previousSiblings: R,
          nextSiblings: ae,
          siblings: oe,
          match: se,
          ...
          adjacent: fe,
          descendantOf: H,
          getElementsBySelector: de,
          childElements: ie,
        });
        var he = 1;
        function U(e) {
          e = i(e);
          var t = l.readAttribute(e, `id`);
          if (t) return t;
          do t = `anonymous_element_` + he++;
          while (i(t));
          return (l.writeAttribute(e, `id`, t), t);
        }
        function W(e, t) {
        ...
        function ge(e, t) {
          ...
          return n.values[t]
            ...
            : (n.names[t] && (t = n.names[t]),
              t.include(`:`)
                ? !e.attributes || !e.attributes[t]
                  ? null
                  : e.attributes[t].value
                : e.getAttribute(t));
        }
        function G(e, t) {
          return t === `title` ? e.title : e.getAttribute(t);
        }
        (function () {
          r.setAttribute(`onclick`, []);
          var e = r.getAttribute(`onclick`),
            t = Object.isArray(e);
          return (r.removeAttribute(`onclick`), t);
        })()
          ? (W = ge)
          : Prototype.Browser.Opera && (W = G);
        function _e(e, t, n) {
          e = i(e);
          var r = {},
            a = K.write;
          for (var o in (typeof t == `object`
            ? (r = t)
            : (r[t] = Object.isUndefined(n) ? !0 : n),
          r))
            ((t = a.names[o] || o),
              (n = r[o]),
              !(
                a.values[o] && ((n = a.values[o](e, n)), Object.isUndefined(n))
              ) &&
                (n === !1 || n === null
                  ? e.removeAttribute(t)
                  : n === !0
        ...
        var ve = (function () {
          if (!s) return !1;
          var e = document.createElement(`<input type="checkbox">`);
          e.checked = !0;
          var t = e.getAttributeNode(`checked`);
          return !t || !t.specified;
        })();
        function ye(e, t) {
          t = K.has[t] || t;
          var n = i(e).getAttributeNode(t);
          return !!(n && n.specified);
        }
        function be(e, t) {
          return t === `checked` ? e.checked : ye(e, t);
        }
        e.Element.Methods.Simulated.hasAttribute = ve ? be : ye;
        function xe(e) {
          return new l.ClassNames(e);
        }
        var Se = {};
        function Ce(e) {
          if (Se[e]) return Se[e];
        ...
        function we(e, t) {
          if ((e = i(e))) {
            var n = e.className;
            return n.length === 0 ? !1 : n === t ? !0 : Ce(t).test(n);
          }
        }
        function Te(e, t) {
          if ((e = i(e)))
            return (
              we(e, t) || (e.className += (e.className ? ` ` : ``) + t),
              e
            );
        }
        function Ee(e, t) {
          if ((e = i(e)))
            return ((e.className = e.className.replace(Ce(t), ` `).strip()), e);
        }
        function De(e, t, n) {
          if ((e = i(e))) {
            Object.isUndefined(n) && (n = !we(e, t));
            var r = l[n ? `addClassName` : `removeClassName`];
            return r(e, t);
          }
        }
        var K = {},
        ...
        (r.setAttribute(Oe, `x`),
          r.className !== `x` &&
            ...
            r.className === `x` && (Oe = `class`)));
        var J = document.createElement(`label`);
        (J.setAttribute(q, `x`),
          J.htmlFor !== `x` &&
            (J.setAttribute(`htmlFor`, `x`),
            J.htmlFor === `x` && (q = `htmlFor`)),
          (J = null));
        function ke(e, t) {
        ...
        function Me(e, t) {
          return i(e).hasAttribute(t) ? t : null;
        }
        r.onclick = Prototype.emptyFunction;
        var Ne = r.getAttribute(`onclick`),
          Y;
        (String(Ne).indexOf(`{`) > -1
          ? (Y = function (e, t) {
          ...
          : Ne === `` &&
            (Y = function (e, t) {
              var n = e.getAttribute(t);
              return n ? n.strip() : null;
            }),
          (K.read = {
            names: { class: Oe, className: Oe, for: q, htmlFor: q },
            values: {
              style: function (e) {
          ...
          (K.write = {
            ...
            values: {
              checked: function (e, t) {
                return ((t = !!t), (e.checked = t), t ? `checked` : null);
              },
              style: function (e, t) {
                e.style.cssText = t || ``;
              },
          ...
          (K.has = { names: {} }),
          Object.extend(K.write.names, K.read.names));
        for (
          var Pe = $w(
          ...
          ((K.write.names[Ie.toLowerCase()] = Ie),
            (K.has.names[Ie.toLowerCase()] = Ie));
        (Object.extend(K.read.values, {
          href: Ae,
          src: Ae,
          type: ke,
          action: je,
        ...
        function Le(e) {
          return e === `float` || e === `styleFloat`
            ? `cssFloat`
            : e.camelize();
        }
        function Re(e) {
          return e === `float` || e === `cssFloat`
            ? `styleFloat`
            : e.camelize();
        }
        function ze(e, t) {
          ...
          if (Object.isString(t)) {
            if (((n.cssText += `;` + t), t.include(`opacity`))) {
              var a = t.match(/opacity:\s*(\d?\.?\d*)/)[1];
              l.setOpacity(e, a);
            }
            return e;
          }
          for (var o in t)
            if (o === `opacity`) l.setOpacity(e, t[o]);
            else {
              var s = t[o];
              ((o === `float` || o === `cssFloat`) &&
                (o = Object.isUndefined(n.styleFloat)
                  ? `cssFloat`
                  : `styleFloat`),
                (n[o] = s));
            }
        ...
        function Ue(e) {
          return (
            (!e.currentStyle || !e.currentStyle.hasLayout) &&
              (e.style.zoom = 1),
            e
          );
        }
        ...
        function Ke(e, t) {
          if (We) return Ge(e, t);
          e = Ue(i(e));
          var n = l.getStyle(e, `filter`),
            r = e.style;
          return t == 1 || t === ``
            ? ((n = He(n)), n ? (r.filter = n) : r.removeAttribute(`filter`), e)
            : (t < 1e-5 && (t = 0),
              (r.filter = He(n) + ` alpha(opacity=` + t * 100 + `)`),
              e);
        }
        function qe(e) {
          return l.getStyle(e, `opacity`);
        }
        function Je(e) {
          if (We) return qe(e);
          var t = l.getStyle(e, `filter`);
          if (t.length === 0) return 1;
          var n = (t || ``).match(/alpha\(opacity=(.*)\)/i);
          return n && n[1] ? parseFloat(n[1]) / 100 : 1;
        }
        (Object.extend(u, {
          setStyle: ze,
          getStyle: Be,
          ...
          `styleFloat` in r.style &&
            ((u.getStyle = Ve), (u.setOpacity = Ke), (u.getOpacity = Je)));
        var Ye = 0;
        e.Element.Storage = { UID: 1 };
        function Xe(e) {
          return e === window
            ? 0
            : (e._prototypeUID === void 0 &&
                (e._prototypeUID = l.Storage.UID++),
              e._prototypeUID);
        }
        function Ze(e) {
          return e === window ? 0 : e == document ? 1 : e.uniqueID;
        }
        var Qe = `uniqueID` in r;
        Qe && (Xe = Ze);
        function $e(e) {
          if ((e = i(e))) {
            var t = Xe(e);
            return (l.Storage[t] || (l.Storage[t] = $H()), l.Storage[t]);
          }
        }
        function et(e, t, n) {
          if ((e = i(e))) {
            var r = $e(e);
            return (arguments.length === 2 ? r.update(t) : r.set(t, n), e);
          }
        }
        function tt(e, t, n) {
          if ((e = i(e))) {
            var r = $e(e),
              a = r.get(t);
            return (Object.isUndefined(a) && (r.set(t, n), (a = n)), a);
          }
        }
        Object.extend(u, { getStorage: $e, store: et, retrieve: tt });
        var nt = {},
          rt = l.Methods.ByTag,
          it = Prototype.BrowserFeatures;
        !it.ElementExtensions &&
          `__proto__` in r &&
          ((e.HTMLElement = {}),
          (e.HTMLElement.prototype = r.__proto__),
          (it.ElementExtensions = !0));
        function at(e) {
          if (window.Element === void 0 || !s) return !1;
        ...
        function st(e, t) {
          for (var n in t) {
            var r = t[n];
            Object.isFunction(r) && !(n in e) && (e[n] = r.methodize());
          }
        }
        var ct = {};
        function lt(e) {
        ...
        function ut(e) {
          if (!e || lt(e) || e.nodeType !== Node.ELEMENT_NODE || e == window)
            return e;
          var t = Object.clone(nt),
            n = e.tagName.toUpperCase();
          return (
            rt[n] && Object.extend(t, rt[n]),
            st(e, t),
            (ct[Xe(e)] = !0),
            e
          );
        ...
        function dt(e) {
          ...
          return (
            t &&
              ...
              (st(e, l.Methods),
              st(e, l.Methods.Simulated),
              st(e, l.Methods.ByTag[t.toUpperCase()])),
            e
          );
        }
        it.SpecificElementExtensions && (ut = ot ? dt : Prototype.K);
        function ft(e, t) {
          ((e = e.toUpperCase()),
            rt[e] || (rt[e] = {}),
            Object.extend(rt[e], t));
        }
        function X(e, t, n) {
          for (var r in (Object.isUndefined(n) && (n = !1), t)) {
            var i = t[r];
            Object.isFunction(i) && (!n || !(r in e)) && (e[r] = i.methodize());
          }
        }
        function Z(e) {
          var t,
          ...
          if (
            ...
            window[t] ||
              ((t = `HTML` + e + `Element`), window[t]) ||
              ((t = `HTML` + e.capitalize() + `Element`), window[t]))
          )
            return window[t];
          var r = document.createElement(e),
            i = r.__proto__ || r.constructor.prototype;
          return ((r = null), i);
        }
        function pt(e) {
          if ((arguments.length === 0 && mt(), arguments.length === 2)) {
            var t = e;
            e = arguments[1];
          }
          if (!t) Object.extend(l.Methods, e || {});
          else if (Object.isArray(t))
            for (var n = 0, r; (r = t[n]); n++) ft(r, e);
          else ft(t, e);
          var i = window.HTMLElement ? HTMLElement.prototype : l.prototype;
          if (
            (it.ElementExtensions &&
              (X(i, l.Methods), X(i, l.Methods.Simulated, !0)),
            it.SpecificElementExtensions)
          )
            for (var r in l.Methods.ByTag) {
              var o = Z(r);
              Object.isUndefined(o) || X(o.prototype, rt[r]);
            }
          (Object.extend(l, l.Methods),
            Object.extend(l, l.Methods.Simulated),
            delete l.ByTag,
            delete l.Simulated,
            l.extend.refresh(),
            (a = {}));
        }
        (Object.extend(e.Element, { extend: ut, addMethods: pt }),
          ut === Prototype.K
            ? (e.Element.extend.refresh = Prototype.emptyFunction)
            : (e.Element.extend.refresh = function () {
                Prototype.BrowserFeatures.ElementExtensions ||
                  (Object.extend(nt, l.Methods),
                  Object.extend(nt, l.Methods.Simulated),
                  (ct = {}));
              }));
        function mt() {
          (Object.extend(Form, Form.Methods),
            Object.extend(Form.Element, Form.Element.Methods),
            Object.extend(l.Methods.ByTag, {
        ...
        window.attachEvent && window.attachEvent(`onunload`, ht);
      })(window),
      (function () {
        function e(e) {
          var t = e.match(/^(\d+)%?$/i);
        ...
        function r(e, t) {
          var n = e.offsetWidth,
            r = i(e, `borderLeftWidth`, t) || 0,
            a = i(e, `borderRightWidth`, t) || 0,
            o = i(e, `paddingLeft`, t) || 0,
            s = i(e, `paddingRight`, t) || 0;
          return n - r - a - o - s;
        }
        ...
        function i(n, r, i) {
          var a = null;
          if (
            (Object.isElement(n) && ((a = n), (n = t(a, r))),
            n === null || Object.isUndefined(n))
          )
            return null;
          if (/^(?:-)?\d+(\.\d+)?(px)?$/i.test(n)) return window.parseFloat(n);
          var o = n.include(`%`),
            s = i === document.viewport;
          if (/\d/.test(n) && a && a.runtimeStyle && !(o && s)) {
            var c = a.style.left,
              l = a.runtimeStyle.left;
            return (
          ...
          if (a && o) {
            ...
            var u = e(n),
              d = null,
              f = r.include(`left`) || r.include(`right`) || r.include(`width`),
              p =
                r.include(`top`) || r.include(`bottom`) || r.include(`height`);
            return (
              i === document.viewport
                ? f
                  ? (d = document.viewport.getWidth())
                  : p && (d = document.viewport.getHeight())
                : f
                  ? (d = $(i).measure(`width`))
                  : p && (d = $(i).measure(`height`)),
              d === null ? 0 : d * u
            );
          }
          return 0;
        ...
        ((Element.Layout = Class.create(Hash, {
          ...
          get: function (e, t) {
            var n = e(t);
            return n === null ? this._compute(t) : n;
          },
          _begin: function () {
            if (!this._isPrepared()) {
              var e = this.element;
              ...
              e.store(`prototype_original_styles`, n);
              var i = t(e, `position`),
                o = e.offsetWidth;
              (o === 0 || o === null) &&
                ((e.style.display = `block`), (o = e.offsetWidth));
              var s = i === `fixed` ? document.viewport : e.parentNode,
                c = { visibility: `hidden`, display: `block` };
              (i !== `fixed` && (c.position = `absolute`), e.setStyle(c));
              var l = e.offsetWidth,
                u;
              if (o && l === o) u = r(e, s);
              else if (i === `absolute` || i === `fixed`) u = r(e, s);
              else {
                var d = e.parentNode;
                u =
                  $(d).getLayout().get(`width`) -
              ...
              (e.setStyle({ width: u + `px` }), this._setPrepared(!0));
            }
          },
          _end: function () {
            var e = this.element,
          ...
          _isPrepared: function () {
            return this.element.retrieve(
              `prototype_element_layout_prepared`,
              !1
            );
          },
          _setPrepared: function (e) {
            return this.element.store(`prototype_element_layout_prepared`, e);
          },
          toObject: function () {
            var e = $A(arguments),
              t =
          ...
          toHash: function () {
            return new Hash(this.toObject.apply(this, arguments));
          },
          toCSS: function () {
            var e = $A(arguments),
              t =
            ...
            return (
              t.each(function (e) {
                if (
                  Element.Layout.PROPERTIES.include(e) &&
                  !Element.Layout.COMPOSITE_PROPERTIES.include(e)
                ) {
                  var t = this.get(e);
                  t != null && (n[s(e)] = t + `px`);
                }
            ...
            COMPUTATIONS: {
              height: function (e) {
                ...
                var n = this.get(`border-top`),
                  r = this.get(`border-bottom`),
                  i = this.get(`padding-top`),
                  a = this.get(`padding-bottom`);
                return (this._preComputing || this._end(), t - n - r - i - a);
              },
              width: function (e) {
                this._preComputing || this._begin();
              ...
              bottom: function (e) {
                ...
                return (
                  e.getOffsetParent().measure(`height`) -
              ...
              right: function (e) {
                var t = e.positionedOffset();
                return (
                  e.getOffsetParent().measure(`width`) -
                  this.get(`border-box-width`) -
                  t.left
                );
              },
              'padding-top': function (e) {
                return i(e, `paddingTop`);
              },
              'padding-bottom': function (e) {
                return i(e, `paddingBottom`);
              },
              'padding-left': function (e) {
                return i(e, `paddingLeft`);
              },
              'padding-right': function (e) {
                return i(e, `paddingRight`);
              },
              'border-top': function (e) {
                return i(e, `borderTopWidth`);
              },
              'border-bottom': function (e) {
                return i(e, `borderBottomWidth`);
              },
              'border-left': function (e) {
                return i(e, `borderLeftWidth`);
              },
              'border-right': function (e) {
                return i(e, `borderRightWidth`);
              },
              'margin-top': function (e) {
                return i(e, `marginTop`);
              },
              'margin-bottom': function (e) {
                return i(e, `marginBottom`);
              },
              'margin-left': function (e) {
                return i(e, `marginLeft`);
              },
              'margin-right': function (e) {
                return i(e, `marginRight`);
              },
            },
          }),
          `getBoundingClientRect` in document.documentElement &&
            Object.extend(Element.Layout.COMPUTATIONS, {
              right: function (e) {
                var t = o(e.getOffsetParent()),
                  n = e.getBoundingClientRect();
                return (t.getBoundingClientRect().right - n.right).round();
              },
              bottom: function (e) {
                var t = o(e.getOffsetParent()),
                  n = e.getBoundingClientRect();
                return (t.getBoundingClientRect().bottom - n.bottom).round();
              },
            }),
        ...
        function f(e) {
          ...
          var n = e.style,
            ...
            i = { visibility: `hidden`, display: `block` };
          (r.position !== `fixed` && (i.position = `absolute`),
            Element.setStyle(e, i));
          var a = { width: e.offsetWidth, height: e.offsetHeight };
          return (Element.setStyle(e, r), a);
        }
        function p(e) {
          e = $(e);
          function t(e) {
            return D(e) ? $(document.body) : $(e);
          }
        ...
        function h(e) {
          ...
          do
            if (
              ...
              (r += e.offsetLeft || 0),
              (e = e.offsetParent),
              e && (E(e) || Element.getStyle(e, `position`) !== `static`))
            )
              break;
          while (e);
          return (
          ...
          do
            if (e === document.body) {
              var r =
                ...
                document.body;
              ((t += Object.isUndefined(window.pageYOffset)
                ? r.scrollTop || 0
                : window.pageYOffset),
                (n += Object.isUndefined(window.pageXOffset)
                  ? r.scrollLeft || 0
                  : window.pageXOffset));
              break;
            } else
        ...
        function _(e) {
          ...
          do
            if (
              ...
              (n += i.offsetLeft || 0),
              i.offsetParent == r &&
                Element.getStyle(i, `position`) == `absolute`)
            )
              break;
          while ((i = i.offsetParent));
          i = e;
          do i != r && ((t -= i.scrollTop || 0), (n -= i.scrollLeft || 0));
          while ((i = i.parentNode));
          return new Element.Offset(n, t);
        }
        function v(e) {
          if (((e = $(e)), Element.getStyle(e, `position`) === `absolute`))
            return e;
          var t = p(e),
            n = e.viewportOffset(),
            r = t.viewportOffset(),
          ...
          return (
            ...
            e.setStyle({
              ...
              top: i.top + `px`,
              left: i.left + `px`,
              width: a.get(`width`) + `px`,
              height: a.get(`height`) + `px`,
            }),
            e
          );
        }
        function y(e) {
          if (((e = $(e)), Element.getStyle(e, `position`) === `relative`))
            return e;
        ...
        function b(e) {
          ...
          return (window.scrollTo(t.left, t.top), e);
        }
        function x(e) {
          e = $(e);
          ...
          return (
            (t === `static` || !t) &&
              ((n.position = `relative`),
              Prototype.Browser.Opera && ((n.top = 0), (n.left = 0)),
              Element.setStyle(e, n),
              Element.store(e, `prototype_made_positioned`, !0)),
            e
          );
        }
        function S(e) {
          e = $(e);
          var t = Element.getStorage(e);
          return (
            t.get(`prototype_made_positioned`) &&
              (t.unset(`prototype_made_positioned`),
              Element.setStyle(e, {
                position: ``,
                top: ``,
                bottom: ``,
        ...
        function C(e) {
          e = $(e);
          var t = Element.getStorage(e),
            n = t.get(`prototype_made_clipping`);
          if (Object.isUndefined(n)) {
            var r = Element.getStyle(e, `overflow`);
            (t.set(`prototype_made_clipping`, r),
              r !== `hidden` && (e.style.overflow = `hidden`));
          }
          return e;
        }
        function w(e) {
          ...
          return (
            Object.isUndefined(n) ||
              (t.unset(`prototype_made_clipping`),
              (e.style.overflow = n || ``)),
            e
          );
        }
        function T(e, t, n) {
          ...
          if (
            (n.setLeft || n.setTop) &&
            ((i = Element.viewportOffset(t)),
            (a = [0, 0]),
            Element.getStyle(e, `position`) === `absolute`)
          ) {
            var c = Element.getOffsetParent(e);
            c !== document.body && (a = Element.viewportOffset(c));
          }
          function l() {
            var e = 0,
              t = 0;
          ...
          var u = l();
          ((n.setWidth || n.setHeight) && (o = Element.getLayout(t)),
            n.setLeft && (s.left = i[0] + u.x - a[0] + n.offsetLeft + `px`),
            n.setTop && (s.top = i[1] + u.y - a[1] + n.offsetTop + `px`));
          var d = e.getLayout();
          return (
            n.setWidth && (s.width = o.get(`width`) + `px`),
            n.setHeight && (s.height = o.get(`height`) + `px`),
            Element.setStyle(e, s)
          );
        }
        (Prototype.Browser.IE
          ? ((p = p.wrap(function (e, t) {
              if (((t = $(t)), O(t) || k(t) || E(t) || D(t)))
                return $(document.body);
              var n = t.getStyle(`position`);
              if (n !== `static`) return e(t);
              t.setStyle({ position: `relative` });
              var r = e(t);
              return (t.setStyle({ position: n }), r);
            })),
            (h = h.wrap(function (e, t) {
              if (((t = $(t)), !t.parentNode)) return new Element.Offset(0, 0);
              var n = t.getStyle(`position`);
              if (n !== `static`) return e(t);
              var r = t.getOffsetParent();
              (r && r.getStyle(`position`) === `fixed` && o(r),
                t.setStyle({ position: `relative` }));
              var i = e(t);
        ...
        function E(e) {
          return e.nodeName.toUpperCase() === `BODY`;
        }
        function D(e) {
          return e.nodeName.toUpperCase() === `HTML`;
        }
        function O(e) {
        ...
        `getBoundingClientRect` in document.documentElement &&
          Element.addMethods({
            viewportOffset: function (e) {
              if (((e = $(e)), k(e))) return new Element.Offset(0, 0);
      ...
      (function () {
        var e =
          ...
          t = null;
        function n() {
          return t || ((t = e ? document.body : document.documentElement), t);
        }
        function r() {
      ...
      (Prototype.Selector = (function () {
        ...
        function n(e, t, n) {
          n ||= 0;
          var r = Prototype.Selector.match,
            i = e.length,
            a = 0,
            o;
          for (o = 0; o < i; o++)
            if (r(e[o], t) && n == a++) return Element.extend(e[o]);
        }
        function r(e) {
        ...
        return {
          ...
          match: t,
          find: n,
          extendElements: Element.extend === i ? i : r,
      ...
      (function (e) {
        ...
        function H(e, t, r, i) {
          var a, o, c, l, u, p, g, _, x, S;
          if (
            ((t ? t.ownerDocument || t : b) !== f && d(t),
            (t ||= f),
            (r ||= []),
            !e || typeof e != `string`)
          )
          ...
          if (m && !i) {
            if ((a = de.exec(e))) {
              if ((c = a[1])) {
                if (l === 9)
                  if (((o = t.getElementById(c)), o && o.parentNode)) {
                    if (o.id === c) return (r.push(o), r);
                  } else return r;
                else if (
                  t.ownerDocument &&
                ...
                return (M.apply(r, t.getElementsByTagName(e)), r);
              else if (
                (c = a[3]) &&
                n.getElementsByClassName &&
                t.getElementsByClassName
              )
                return (M.apply(r, t.getElementsByClassName(c)), r);
            }
            if (n.qsa && (!h || !h.test(e))) {
              if (
                ((_ = g = y),
                ...
                for (
                  ...
                  p[u] = _ + Ce(p[u]);
                ((x = (fe.test(e) && be(t.parentNode)) || t),
                  (S = p.join(`,`)));
              }
              if (S)
                try {
                  return (M.apply(r, x.querySelectorAll(S)), r);
                } catch {
                } finally {
        ...
        (d = H.setDocument =
          function (e) {
            var t,
              ...
              o = i.defaultView;
            return i === f || i.nodeType !== 9 || !i.documentElement
              ? f
              : ((f = i),
                (p = i.documentElement),
                (m = !a(i)),
                ...
                (n.attributes = W(function (e) {
                  return ((e.className = `i`), !e.getAttribute(`className`));
                })),
                (n.getElementsByTagName = W(function (e) {
                  return (
                ...
                (n.getElementsByClassName =
                  B.test(i.getElementsByClassName) &&
                  W(function (e) {
                    return (
                ...
                (r.find.CLASS =
                  n.getElementsByClassName &&
                  function (e, t) {
                    if (typeof t.getElementsByClassName !== D && m)
                      return t.getElementsByClassName(e);
                  }),
                (g = []),
                (h = []),
                (n.qsa = B.test(i.querySelectorAll)) &&
                  (W(function (e) {
                ...
                (n.matchesSelector = B.test(
                  ...
                  W(function (e) {
                    ((n.disconnectedMatch = _.call(e, `div`)),
                      _.call(e, `[s!='']:x`),
                      g.push(`!=`, re));
                  }),
                (h = h.length && new RegExp(h.join(`|`))),
                (g = g.length && new RegExp(g.join(`|`))),
                (t = B.test(p.compareDocumentPosition)),
                (v =
                  t || B.test(p.contains)
                    ? function (e, t) {
        ...
        (H.matchesSelector = function (e, t) {
          if (
            ...
            (t = t.replace(oe, `='$1']`)),
            n.matchesSelector && m && (!g || !g.test(t)) && (!h || !h.test(t)))
          )
            try {
              var r = _.call(e, t);
              if (
        ...
        (H.attr = function (e, t) {
          ...
          var i = r.attrHandle[t.toLowerCase()],
            a =
              i && k.call(r.attrHandle, t.toLowerCase()) ? i(e, t, !m) : void 0;
          return a === void 0
            ? n.attributes || !m
              ? e.getAttribute(t)
        ...
        (r = H.selectors =
          {
            ...
            preFilter: {
              ATTR: function (e) {
                return (
                  (e[1] = e[1].replace(me, V)),
                  (e[3] = (e[4] || e[5] || ``).replace(me, V)),
                  e[2] === `~=` && (e[3] = ` ` + e[3] + ` `),
                  e.slice(0, 4)
                );
              },
            ...
            filter: {
              TAG: function (e) {
                var t = e.replace(me, V).toLowerCase();
                return e === `*`
                  ? function () {
                      return !0;
                    }
                ...
                return r === 1 && i === 0
                  ...
                  : function (t, n, c) {
                      var l,
                        ...
                        p,
                        m,
                        h = a === o ? `previousSibling` : `nextSibling`,
                        g = t.parentNode,
            ...
            pseudos: {
              ...
              lang: U(function (e) {
                return (
                  ce.test(e || ``) || H.error(`unsupported lang: ` + e),
                  (e = e.replace(me, V).toLowerCase()),
                  function (t) {
                    var n;
                    do
                      if (
        ...
        function xe() {}
        ((xe.prototype = r.filters = r.pseudos), (r.setFilters = new xe()));
        function Se(e, t) {
          var n,
            i,
            a,
          ...
          for (s = e, c = [], l = r.preFilter; s;) {
            ...
            (i = ae.exec(s)) &&
              ((n = i.shift()),
              a.push({ value: n, type: i[0].replace(ie, ` `) }),
              (s = s.slice(n.length))),
            r.filter))
              (i = le[o].exec(s)) &&
                (!l[o] || (i = l[o](i))) &&
          ...
          return t ? s.length : s ? H.error(e) : w(e, c).slice(0);
        }
        function Ce(e) {
          ...
          return (
            ...
            U(function (a, o, s, c) {
              ...
              if (a) {
                ...
                ((_ = De(_ === o ? _.splice(m, _.length) : _)),
                  i ? i(null, o, _, c) : M.apply(o, _));
            })
          );
        }
        function Oe(e) {
          for (
            ...
            if ((n = r.relative[e[l].type])) f = [we(Te(f), n)];
            else {
        ...
        ((o = H.compile =
          ...
          (s = H.select =
            function (e, t, i, a) {
              var s,
                ...
                u,
                d,
                f = typeof e == `function` && e,
                p = !a && Se((e = f.selector || e));
              if (((i ||= []), p.length === 1)) {
                if (
                  ((c = p[0] = p[0].slice(0)),
                  c.length > 2 &&
                  ...
                  if (
                    ((t = (r.find.ID(l.matches[0].replace(me, V), t) || [])[0]),
                    t)
                  )
                    f && (t = t.parentNode);
                  else return i;
                ...
                for (
                  s = le.needsContext.test(e) ? 0 : c.length;
                  s-- && ((l = c[s]), !r.relative[(u = l.type)]);
                )
                  if (
                    (d = r.find[u]) &&
                    (a = d(
                      l.matches[0].replace(me, V),
                      (fe.test(c[0].type) && be(t.parentNode)) || t
                    ))
                  ) {
                    if ((c.splice(s, 1), (e = a.length && Ce(c)), !e))
                      return (M.apply(i, a), i);
                    break;
                  }
              }
              return (
          ...
          d(),
          (n.sortDetached = W(function (e) {
            return e.compareDocumentPosition(f.createElement(`div`)) & 1;
          })),
          W(function (e) {
            return (
      ...
      (function () {
        typeof Sizzle < `u` ||
          (typeof define < `u` && define.amd
            ...
            : module !== void 0 &&
              module.exports &&
              ((window.Sizzle = module.exports), (module.exports = {})));
      })(),
      (function (e) {
        var t = Prototype.Selector.extendElements;
        function n(n, r) {
          return t(e(n, r || document));
        }
        function r(t, n) {
          return e.matches(n, [t]).length == 1;
        }
        ((Prototype.Selector.engine = e),
          (Prototype.Selector.select = n),
          (Prototype.Selector.match = r));
      })(Sizzle),
      ...
      serializeElements: function (e, t) {
        ...
        return (
          t.hash
            ...
            : ((s = ``),
              (o = function (e, t, n) {
                if ((Object.isArray(n) || (n = [n]), !n.length)) return e;
                var r = encodeURIComponent(t).gsub(/%20/, `+`);
                return (
                  e +
                  (e ? `&` : ``) +
                  n
...
`
    ...
    ((Form.Methods = {
      ...
      getElements: function (e) {
        for (
          var t = $(e).getElementsByTagName(`*`),
            n,
            r = [],
            i = Form.Element.Serializers,
            a = 0;
          (n = t[a]);
          a++
        )
          i[n.tagName.toLowerCase()] && r.push(Element.extend(n));
        return r;
      },
      getInputs: function (e, t, n) {
        ...
        for (var i = 0, a = [], o = r.length; i < o; i++) {
          var s = r[i];
          (t && s.type != t) || (n && s.name != n) || a.push(Element.extend(s));
        }
        return a;
      },
      disable: function (e) {
      ...
      request: function (e, t) {
        ...
        return (
          ...
          n &&
            (Object.isString(n) && (n = n.toQueryParams()),
            Object.extend(t.parameters, n)),
            ...
            (e.focus(),
              e.select &&
                (e.tagName.toLowerCase() != `input` ||
                  !/^(?:button|reset|submit)$/i.test(e.type)) &&
                e.select());
          } catch {}
          return e;
        },
    ...
    ((Form.Element.Serializers = (function () {
      ...
      function r(e, t) {
        if (Object.isUndefined(t)) return (e.type === `select-one` ? i : a)(e);
        for (var n, r, o = !Object.isArray(t), s = 0, c = e.length; s < c; s++)
          if (((n = e.options[s]), (r = this.optionValue(n)), o)) {
            if (r == t) {
              n.selected = !0;
              return;
            }
      ...
      (Abstract.TimedObserver = Class.create(PeriodicalExecuter, {
        ...
        execute: function () {
          var e = this.getValue();
          (Object.isString(this.lastValue) && Object.isString(e)
            ? this.lastValue != e
            : String(this.lastValue) != String(e)) &&
            (this.callback(this.element, e), (this.lastValue = e));
        },
      })),
      ...
      (function (e) {
        var t = document.createElement(`div`),
          n = document.documentElement,
          r = `onmouseenter` in n && `onmouseleave` in n,
          i = {
            KEY_BACKSPACE: 8,
            KEY_TAB: 9,
            KEY_RETURN: 13,
        ...
        function u(e, t) {
          switch (t) {
            ...
            case 1:
              return e.which == 2 || (e.which == 1 && e.metaKey);
            case 2:
              return e.which == 3;
            default:
              return !1;
        ...
        function v(e) {
          var t = document.documentElement,
            n = document.body || { scrollLeft: 0 };
          return (
            e.pageX ||
            e.clientX + (t.scrollLeft || n.scrollLeft) - (t.clientLeft || 0)
          );
        }
        function y(e) {
          var t = document.documentElement,
          ...
          return (
            e.pageY ||
            e.clientY + (t.scrollTop || n.scrollTop) - (t.clientTop || 0)
          );
        }
        function b(e) {
          (i.extend(e),
        ...
        var x = Object.keys(i.Methods).inject({}, function (e, t) {
          return ((e[t] = i.Methods[t].methodize()), e);
        });
        if (window.attachEvent) {
          ...
          i.extend = function (t, n) {
            if (!t) return !1;
            if (!a(t) || t._extendedByPrototype) return t;
            t._extendedByPrototype = Prototype.emptyFunction;
            var r = i.pointer(t);
            return (
              Object.extend(t, {
                target: t.srcElement || n,
                relatedTarget: e(t),
                pageX: r.x,
                pageY: r.y,
              }),
        ...
        } else i.extend = Prototype.K;
        window.addEventListener &&
          ((i.prototype =
            window.Event.prototype ||
            document.createEvent(`HTMLEvents`).__proto__),
          Object.extend(i.prototype, x));
        ...
        function T(e) {
          return e === window
            ? 0
            : (e._prototypeUID === void 0 &&
                (e._prototypeUID = Element.Storage.UID++),
              e._prototypeUID);
        }
        function E(e) {
          return e === window ? 0 : e == document ? 1 : e.uniqueID;
        ...
        function O(t, n) {
          var r = e.Event.cache;
          return (
            Object.isUndefined(n) && (n = T(t)),
            r[n] || (r[n] = { element: t }),
            r[n]
          );
        }
        function k(t, n) {
          (Object.isUndefined(n) && (n = T(t)), delete e.Event.cache[n]);
        }
        function A(t, n, r) {
          var i = O(t);
          i[n] || (i[n] = []);
        ...
        function ee(e, t, n) {
          ...
          return (
            i.length === 0 &&
              (delete r[t],
              Object.keys(r).length === 1 && `element` in r && k(e)),
            o
          );
        }
        function j(e, t, n) {
        ...
        function N(e, t, n) {
          e.addEventListener
            ? e.addEventListener(`dataavailable`, n, !1)
            : (e.attachEvent(`ondataavailable`, n),
              e.attachEvent(`onlosecapture`, n));
        }
        function P(e, t, n) {
          e = $(e);
          var r = !Object.isUndefined(n);
          if (Object.isUndefined(t) && !r) return (L(e), e);
          if (!r) return (te(e, t), e);
          var i = ee(e, t, n);
          return (i && ne(e, t, i.responder), e);
        }
        function F(e, t, n) {
          var r = w(t);
          e.removeEventListener
            ? e.removeEventListener(r, n, !1)
            : e.detachEvent(`on` + r, n);
        }
        function I(e, t, n) {
          e.removeEventListener
            ? e.removeEventListener(`dataavailable`, n, !1)
            : (e.detachEvent(`ondataavailable`, n),
              e.detachEvent(`onlosecapture`, n));
        }
        function L(t) {
          var n = T(t),
            r = e.Event.cache[n];
        ...
        function re(e) {
          return e === document && document.createEvent && !e.dispatchEvent
            ? document.documentElement
            : e;
        }
        function ie(e, t, n, r) {
          ((e = re($(e))), Object.isUndefined(r) && (r = !0), (n ||= {}));
          var a = oe(e, t, n, r);
          return i.extend(a);
        }
        function R(e, t, n, r) {
        ...
        function ae(e, t, n, r) {
          ...
          return (
            (i.eventType = r ? `ondataavailable` : `onlosecapture`),
            (i.eventName = t),
            (i.memo = n),
            e.fireEvent(i.eventType, i),
            i
          );
        }
        var oe = document.createEvent ? R : ae;
        i.Handler = Class.create({
          initialize: function (e, t, n, r) {
            ((this.element = $(e)),
              (this.eventName = t),
              (this.selector = n),
          ...
          start: function () {
            return (
              i.observe(this.element, this.eventName, this.handler),
              this
            );
          },
          stop: function () {
            return (
              i.stopObserving(this.element, this.eventName, this.handler),
              this
            );
          },
          handleEvent: function (e) {
            var t = i.findElement(e, this.selector);
        ...
        function se(e, t, n, r) {
          return (
            (e = $(e)),
            Object.isFunction(n) &&
              Object.isUndefined(r) &&
              ((r = n), (n = null)),
            new i.Handler(e, t, n, r).start()
          );
        }
        (Object.extend(i, i.Methods),
          Object.extend(i, { fire: ie, observe: j, stopObserving: P, on: se }),
          Element.addMethods({
            fire: ie,
            observe: j,
            stopObserving: P,
          ...
          Object.extend(document, {
            fire: ie.methodize(),
            observe: j.methodize(),
            stopObserving: P.methodize(),
            on: se.methodize(),
            loaded: !1,
          }),
          e.Event ? Object.extend(window.Event, i) : (e.Event = i),
          (e.Event.cache = {}));
        function ce() {
          e.Event.cache = null;
        }
        (window.attachEvent && window.attachEvent(`onunload`, ce),
          (t = null),
          (n = null));
      })(window),
      (function (e) {
        var t = document.documentElement,
          n = `onmouseenter` in t && `onmouseleave` in t;
        function r(e) {
          return !n && (e === `mouseenter` || e === `mouseleave`);
        }
        function i(e, t, n) {
          return Event._isCustomEvent(t)
            ? a(e, t, n)
            : r(t)
              ? o(e, t, n)
              : function (t) {
        ...
        function a(e, t, n) {
          return function (r) {
            var i = Event.cache[e],
              a = i && i.element;
            if (Object.isUndefined(r.eventName) || r.eventName !== t) return !1;
            (Event.extend(r, a), n.call(a, r));
          };
        }
        function o(e, t, n) {
          return function (t) {
        ...
        ((e.Event._createResponder = i), (t = null));
      })(window),
      (function (e) {
        var t;
        function n() {
        ...
        function r() {
          document.readyState === `complete` &&
            (document.detachEvent(`onreadystatechange`, r), n());
        }
        function i() {
          try {
        ...
        (document.addEventListener
          ...
          : (document.attachEvent(`onreadystatechange`, r),
            window == top && (t = i.defer())),
          Event.observe(window, `load`, n));
      })(window),
      Element.addMethods(),
    ...
    var Insertion = {
      ...
      Position = {
        ...
        within: function (e, t, n) {
          return this.includeScrollOffsets
            ...
            : ((this.xcomp = t),
              ...
              n >= this.offset[1] &&
                n < this.offset[1] + e.offsetHeight &&
                t >= this.offset[0] &&
                t < this.offset[0] + e.offsetWidth);
        },
        withinIncludingScrolloffsets: function (e, t, n) {
          ...
          return (
            ...
            this.ycomp >= this.offset[1] &&
              this.ycomp < this.offset[1] + e.offsetHeight &&
              this.xcomp >= this.offset[0] &&
              this.xcomp < this.offset[0] + e.offsetWidth
          );
        },
        overlap: function (e, t) {
          ...
          if (e == `vertical`)
            return (
              (this.offset[1] + t.offsetHeight - this.ycomp) / t.offsetHeight
            );
          if (e == `horizontal`)
            return (
              (this.offset[0] + t.offsetWidth - this.xcomp) / t.offsetWidth
            );
        },
        ...
        clone: function (e, t, n) {
          return ((n ||= {}), Element.clonePosition(t, e, n));
        },
      };
    (document.getElementsByClassName ||
      (document.getElementsByClassName = (function (e) {
        ...
        return (
          (e.getElementsByClassName = Prototype.BrowserFeatures.XPath
            ? function (e, n) {
                n = n.toString().strip();
        ...
        ((window.Selector = Class.create({
          ...
          Object.extend(Selector, {
            matchElements: function (e, t) {
              for (
                var n = Prototype.Selector.match, r = [], i = 0, a = e.length;
                i < a;
                i++
              ) {
                var o = e[i];
                n(o, t) && r.push(Element.extend(o));
              }
              return r;
            },
            findElement: function (e, t, n) {
              n ||= 0;
              for (var r = 0, i, a = 0, o = e.length; a < o; a++)
                if (((i = e[a]), Prototype.Selector.match(i, t) && n === r++))
    ...
    ((Scriptaculous = {
      ...
      load: function () {
        function e(e) {
          var t = e.replace(/_.*|\./g, ``);
          return (
            (t = parseInt(t + `0`.times(4 - t.length))),
            e.indexOf(`_`) > -1 ? t - 1 : t
          );
        }
        if (
          typeof Prototype > `u` ||
          typeof Element > `u` ||
          Element.Methods === void 0 ||
          e(Prototype.Version) < e(Scriptaculous.REQUIRED_PROTOTYPE)
        )
          throw (
        ...
        $$(`script[src]`)
          ...
          .each(function (e) {
            var n = e.src.replace(t, ``),
              r = e.src.match(/\?.*load=([a-z,]*)/);
            (r ? r[1] : `builder,effects,dragdrop,controls,slider,sound`)
              .split(`,`)
              .each(function (e) {
...
function jQueryFactory$1(e, t) {
  ...
  function y(e, t, n) {
    ...
    for (r in ((i.text = e), v)) t && t[r] && (i[r] = t[r]);
      ...
      function () {
        ...
        for (
          typeof o == `boolean` && ((l = o), (o = arguments[s] || {}), s++),
            typeof o != `object` && typeof o != `function` && (o = {}),
            s === c && ((o = this), s--);
          s < c;
          s++
        )
  ...
  var w = n.pop,
    ...
    j = /[+~]/,
    M = _.documentElement,
    N = M.matches || M.msMatchesSelector;
  function P() {
    var e = [];
    function t(n, r) {
      return (
        e.push(n + ` `) > S.expr.cacheLength && delete t[e.shift()],
        (t[n + ` `] = r)
      );
    }
    return t;
  ...
  function ae(e) {
    S.error(`Syntax error, unrecognized expression: ` + e);
  }
  var oe = RegExp(`^` + T + `*,` + T + `*`),
    se = P();
  function ce(e, t) {
    ...
    for (o = e, s = [], c = S.expr.preFilter; o;) {
      ...
      (r = A.exec(o)) &&
        ((n = r.shift()),
        i.push({ value: n, type: r[0].replace(O, ` `) }),
        (o = o.slice(n.length))),
      te))
        (r = S.expr.match[a].exec(o)) &&
          (!c[a] || (r = c[a](r))) &&
          ((n = r.shift()),
    ...
    return t ? o.length : o ? ae(e) : se(e, s).slice(0);
  }
  var le = {
    ATTR: function (e) {
      return (
  ...
  function z(e, t, n, r, i, a, o) {
    var s = 0,
      c = e.length,
      l = n == null;
    if (m(n) === `object`) for (s in ((i = !0), n)) z(e, t, s, n[s], !0, a, o);
    else if (
      r !== void 0 &&
      ((i = !0),
    ...
    S.extend({
      attr: function (e, t, n) {
        ...
        if (!(a === 3 || a === 8 || a === 2)) {
          ...
          if (
            ((a !== 1 || !S.isXMLDoc(e)) && (i = S.attrHooks[t.toLowerCase()]),
            n !== void 0)
          ) {
            if (
              n === null ||
              (n === !1 && t.toLowerCase().indexOf(`aria-`) !== 0)
            ) {
              S.removeAttr(e, t);
              return;
            }
    ...
    return (
      ...
      ((n =
        (e.ownerDocument || e) == (t.ownerDocument || t)
          ...
          : 1),
      n & 1
        ? e == _ || (e.ownerDocument == _ && S.contains(_, e))
          ? -1
          : t == _ || (t.ownerDocument == _ && S.contains(_, t))
            ? 1
            : 0
        : n & 4
          ? -1
  ...
  var he,
    ...
    Oe = Pe(
      function (e) {
        return e.disabled === !0 && C(e, `fieldset`);
      },
  ...
  function q(e, t, n, r) {
    ...
    if (!r && (Ne(t), (t ||= W), G)) {
      if (p !== 11 && (l = De.exec(e))) {
        if ((i = l[1])) {
          if (p === 9) return ((s = t.getElementById(i)) && o.call(n, s), n);
          if (f && (s = f.getElementById(i)) && S.contains(t, s))
            return (o.call(n, s), n);
        } else if (l[2]) return (o.apply(n, t.getElementsByTagName(e)), n);
        else if ((i = l[3]) && t.getElementsByClassName)
          return (o.apply(n, t.getElementsByClassName(i)), n);
      }
      if (!xe[e + ` `] && (!D || !D.test(e))) {
        if (((d = e), (f = t), p === 1 && (ee.test(e) || A.test(e)))) {
          for (
            f = (j.test(e) && F(t.parentNode)) || t,
              (f != t || E) &&
                ((c = t.getAttribute(`id`))
                  ? (c = S.escapeSelector(c))
                  : t.setAttribute(`id`, (c = S.expando))),
              u = ce(e),
              a = u.length;
            a--;
          )
            u[a] = (c ? `#` + c : `:scope`) + ` ` + ue(u[a]);
          d = u.join(`,`);
        }
        try {
          ...
          c === S.expando && t.removeAttribute(`id`);
        }
      }
    }
    return He(e.replace(O, `$1`), t, n, r);
  }
  function J(e) {
    return ((e[S.expando] = !0), e);
  }
  function ke(e) {
    return function (t) {
  ...
  for (he in ((q.matches = function (e, t) {
    return q(e, null, null, t);
  }),
  (q.matchesSelector = function (e, t) {
    if ((Ne(e), G && !xe[t + ` `] && (!D || !D.test(t))))
      try {
        return N.call(e, t);
      } catch {
        xe(t, !0);
      }
    return q(t, W, null, [e]).length > 0;
  }),
  (S.expr = {
    cacheLength: 50,
    createPseudo: J,
    ...
    find: {
      ...
      CLASS: function (e, t) {
        if (t.getElementsByClassName !== void 0 && G)
          return t.getElementsByClassName(e);
      },
    },
    relative: {
        ...
        return (
          ...
          ((t = RegExp(`(^|` + T + `)` + e + `(` + T + `|$)`)) &&
            ye(e, function (e) {
              return t.test(
                (typeof e.className == `string` && e.className) ||
                  (e.getAttribute !== void 0 && e.getAttribute(`class`)) ||
                  ``
              );
            }))
        );
        ...
        return r === 1 && i === 0
          ...
          : function (t, n, c) {
              ...
              if (h) {
                ...
                if (((p = [o ? h.firstChild : h.lastChild]), o && _)) {
                  for (
                    u = h[S.expando] || (h[S.expando] = {}),
                      l = u[e] || [],
                      f = l[0] === _e && l[1],
                      v = f && l[2],
                      d = f && h.childNodes[f];
                    ...
                    if (d.nodeType === 1 && ++v && d === t) {
                      u[e] = [_e, f, v];
                      break;
                    }
                } else if (
                  (_ &&
                    ((u = t[S.expando] || (t[S.expando] = {})),
                    (l = u[e] || []),
                    (f = l[0] === _e && l[1]),
                    (v = f)),
                  v === !1)
                  ...
                  for (
                    ...
                    (d = (++f && d && d[m]) || (v = f = 0) || p.pop()) &&
                    !(
                      (s ? C(d, g) : d.nodeType === 1) &&
                      ++v &&
                      (_ &&
                        ((u = d[S.expando] || (d[S.expando] = {})),
                        (u[e] = [_e, v])),
                      d === t)
                    );
                  );
                return ((v -= i), v === r || (v % r === 0 && v / r >= 0));
              }
            };
      },
      PSEUDO: function (e, t) {
        var n =
          S.expr.pseudos[e] ||
          S.expr.setFilters[e.toLowerCase()] ||
          ae(`unsupported pseudo: ` + e);
        return n[S.expando] ? n(t) : n;
      },
    },
    pseudos: {
      not: J(function (e) {
      ...
      lang: J(function (e) {
        return (
          Ce.test(e || ``) || ae(`unsupported lang: ` + e),
          (e = R(e).toLowerCase()),
          function (t) {
            var n;
            do
      ...
      button: function (e) {
        return (C(e, `input`) && e.type === `button`) || C(e, `button`);
      },
      text: function (e) {
        return C(e, `input`) && e.type === `text`;
      },
      first: Me(function () {
        return [0];
      }),
  ...
  (S.expr.pseudos.nth = S.expr.pseudos.eq),
  { radio: !0, checkbox: !0, file: !0, password: !0, image: !0 }))
    S.expr.pseudos[he] = ke(he);
  for (he in { submit: !0, reset: !0 }) S.expr.pseudos[he] = Ae(he);
  function Y() {}
  ((Y.prototype = S.expr.pseudos), (S.expr.setFilters = new Y()));
  function Pe(e, t, n) {
    var r = t.dir,
      i = t.next,
      a = i || r,
  ...
  function Re(e, t, n, r, i, a) {
    return (
      r && !r[S.expando] && (r = Re(r)),
      i && !i[S.expando] && (i = Re(i, a)),
      J(function (a, c, l, u) {
        var d,
          f,
          p,
          ...
          g = [],
          _ = c.length,
          v = a || Ie(t || `*`, l.nodeType ? [l] : l, []),
          y = e && (a || !t) ? Le(v, h, e, l, u) : v;
        if (
        ...
        if (a) {
          ...
          ((m = Le(m === c ? m.splice(_, m.length) : m)),
            i ? i(null, c, m, u) : o.apply(c, m));
      })
    );
  }
  function ze(e) {
    for (
      ...
      if ((n = S.expr.relative[e[c].type])) d = [Pe(Fe(d), n)];
      else {
        if (
          ((n = S.expr.filter[e[c].type].apply(null, e[c].matches)),
          n[S.expando])
        ) {
          for (r = ++c; r < i && !S.expr.relative[e[r].type]; r++);
          return Re(
            c > 1 && Fe(d),
            c > 1 &&
              ue(
    ...
    var n = t.length > 0,
      ...
      i = function (i, a, s, c, l) {
        var u,
          ...
          g = [],
          _ = U,
          v = i || (r && S.expr.find.TAG(`*`, l)),
          y = (_e += _ == null ? 1 : Math.random() || 0.1);
        for (l && (U = a == W || a || l); (u = v[m]) != null; m++) {
          if (r && u) {
            for (
              d = 0, !a && u.ownerDocument != W && (Ne(u), (s = !G));
              (f = e[d++]);
            )
              if (f(u, a || W, s)) {
                o.call(c, u);
        ...
        if (((p += m), n && m !== p)) {
          ...
          (o.apply(c, g),
            l && !i && g.length > 0 && p + t.length > 1 && S.uniqueSort(c));
        }
        return (l && ((_e = y), (U = _)), h);
      };
    return n ? J(i) : i;
    ...
    if (((n ||= []), d.length === 1)) {
      if (
        ...
        a.length > 2 &&
          ...
          t.nodeType === 9 &&
          G &&
          S.expr.relative[a[1].type])
      ) {
        if (((t = (S.expr.find.ID(R(s.matches[0]), t) || [])[0]), t))
          u && (t = t.parentNode);
        else return n;
        e = e.slice(a.shift().value.length);
      }
      for (
        i = we.needsContext.test(e) ? 0 : a.length;
        i-- && ((s = a[i]), !S.expr.relative[(c = s.type)]);
      )
        if (
          (l = S.expr.find[c]) &&
          (r = l(R(s.matches[0]), (j.test(a[0].type) && F(t.parentNode)) || t))
        ) {
          if ((a.splice(i, 1), (e = r.length && ue(a)), !e))
            return (o.apply(n, r), n);
          break;
        }
    }
    return (
      (u || Ve(e, d))(r, t, !G, n, !t || (j.test(e) && F(t.parentNode)) || t),
      n
    );
  }
  (Ne(),
  ...
  var Ge = S.expr.match.needsContext,
    Ke = /^<([a-z][^\/\0>:\x20\t\r\n\f]*)[\x20\t\r\n\f]*\/?>(?:<\/\1>|)$/i;
  function qe(e) {
  ...
  ((S.filter = function (e, t, n) {
    ...
    S.fn.extend({
      ...
      filter: function (e) {
        return this.pushStack(Je(this, e || [], !1));
      },
      not: function (e) {
        return this.pushStack(Je(this, e || [], !0));
      },
      is: function (e) {
        return !!Je(
          this,
          typeof e == `string` && Ge.test(e) ? S(e) : e || [],
          !1
        ).length;
      },
    }));
  var Ye,
    Xe = /^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]+))$/,
    Ze = (S.fn.init = function (e, t) {
      var n, r;
      if (!e) return this;
      if (e.nodeType) return ((this[0] = e), (this.length = 1), this);
      if (typeof e == `function`)
        return Ye.ready === void 0 ? e(S) : Ye.ready(e);
      if (((n = e + ``), qe(n))) n = [null, e, null];
      else if (typeof e == `string`) n = Xe.exec(e);
      else return S.makeArray(e, this);
      if (n && (n[1] || !t))
        if (n[1]) {
          if (
            ...
            S.merge(
              this,
              S.parseHTML(n[1], t && t.nodeType ? t.ownerDocument || t : _, !0)
            ),
            Ke.test(n[1]) && S.isPlainObject(t))
          )
            for (n in t)
              typeof this[n] == `function` ? this[n](t[n]) : this.attr(n, t[n]);
          return this;
        } else
          return (
            (r = _.getElementById(n[2])),
            r && ((this[0] = r), (this.length = 1)),
            this
          );
      else if (!t || t.jquery) return (t || Ye).find(e);
      else return this.constructor(t).find(e);
    });
  ((Ze.prototype = S.fn), (Ye = S(_)));
    ...
    function (e, t) {
      S.fn[e] = function (n, r) {
        ...
        return (
          ...
          this.length > 1 &&
            ($e[e] || S.uniqueSort(i), Qe.test(e) && i.reverse()),
          this.pushStack(i)
        );
      };
    }
  ...
  function it(e, t, n, r) {
    var i;
    try {
      e && typeof (i = e.promise) == `function`
        ? i.call(e).done(t).fail(n)
        : e && typeof (i = e.then) == `function`
          ? i.call(e, t, n)
  ...
  S.extend({
        ...
        i = {
          ...
          pipe: function () {
            ...
            return S.Deferred(function (t) {
              (S.each(n, function (n, r) {
                var i = typeof e[r[4]] == `function` && e[r[4]];
                a[r[1]](function () {
                  var e = i && i.apply(this, arguments);
                  e && typeof e.promise == `function`
                    ? e
                        .promise()
                        .progress(t.notify)
                        .done(t.resolve)
          ...
          then: function (t, r, i) {
                  ...
                  l = function () {
                    ...
                    if (!(t < a)) {
                      ...
                      ((l =
                        ...
                        typeof l == `function`
                          ? i
                            ? l.call(e, o(a, n, nt, i), o(a, n, rt, i))
                            : (a++,
                              l.call(
                                e,
                                o(a, n, nt, i),
                                o(a, n, rt, i),
                                o(a, n, nt, n.notifyWith)
                              ))
                          : (r !== nt && ((s = void 0), (c = [e])),
                            (i || n.resolveWith)(s, c)));
                    }
            ...
            return S.Deferred(function (e) {
              (n[0][3].add(
                o(0, e, typeof i == `function` ? i : nt, e.notifyWith)
              ),
                n[1][3].add(o(0, e, typeof t == `function` ? t : nt)),
                n[2][3].add(o(0, e, typeof r == `function` ? r : rt)));
            }).promise();
          },
          promise: function (e) {
    ...
    when: function (e) {
      ...
      if (
        t <= 1 &&
        (it(e, o.done(s(n)).resolve, o.reject, !t),
  ...
  ((S.Deferred.exceptionHook = function (t, n) {
    t && at.test(t.name) && e.console.warn(`jQuery.Deferred exception`, t, n);
  }),
    ...
    S.extend({
      ...
      ready: function (e) {
        (e === !0 ? --S.readyWait : S.isReady) ||
          ((S.isReady = !0),
          !(e !== !0 && --S.readyWait > 0) && ot.resolveWith(_, [S]));
      },
    }),
    (S.ready.then = ot.then));
  function st() {
    (_.removeEventListener(`DOMContentLoaded`, st),
      e.removeEventListener(`load`, st),
      S.ready());
  }
  _.readyState === `loading`
    ? (_.addEventListener(`DOMContentLoaded`, st),
  ...
  ((ft.uid = 1),
    (ft.prototype = {
      ...
      set: function (e, t, n) {
        var r,
          i = this.cache(e);
        if (typeof t == `string`) i[ut(t)] = n;
        else for (r in t) i[ut(r)] = t[r];
        return n;
      },
      get: function (e, t) {
        return t === void 0
          ? this.cache(e)
          : e[this.expando] && e[this.expando][ut(t)];
      },
  ...
  function gt(e, t, n) {
    ...
    if (n === void 0 && e.nodeType === 1)
      if (
        ((r = `data-` + t.replace(mt, `-$&`).toLowerCase()),
        (n = e.getAttribute(r)),
        typeof n == `string`)
      ) {
        try {
          ...
          : z(
              ...
              function (t) {
                ...
                if (a && t === void 0)
                  return (
                    (n = Z.get(a, e)),
                    n !== void 0 || ((n = gt(a, e)), n !== void 0) ? n : void 0
                  );
                this.each(function () {
                  Z.set(this, e, t);
                });
  ...
  function bt(e, t) {
    return (
      ...
      e.style.display === `none` ||
        (e.style.display === `` && S.css(e, `display`) === `none`)
    );
  }
  var xt = /^[a-z]/,
    St =
  ...
  function Ct(e) {
    return xt.test(e) && St.test(e[0].toUpperCase() + e.slice(1));
  }
  function wt(e, t, n, r) {
    var i,
      a,
    ...
    for (var n, r, i = [], a = 0, o = e.length; a < o; a++)
      ((r = e[a]),
        r.style &&
          ...
          t
            ? (n === `none` &&
                ((i[a] = X.get(r, `display`) || null),
                i[a] || (r.style.display = ``)),
              r.style.display === `` && bt(r) && (i[a] = Ot(r)))
            : n !== `none` && ((i[a] = `none`), X.set(r, `display`, n))));
    ...
    toggle: function (e) {
      return typeof e == `boolean`
        ? e
          ...
          : this.hide()
        : this.each(function () {
            bt(this) ? S(this).show() : S(this).hide();
          });
    },
  });
  var At = function (e) {
      return (
        S.contains(e.ownerDocument, e) || e.getRootNode(jt) === e.ownerDocument
      );
    },
    jt = { composed: !0 };
  M.getRootNode ||
  ...
  function Q(e, t) {
    ...
    return t === void 0 || (t && C(e, t)) ? S.merge([e], r) : r;
  }
  var Pt = /^$|^module$|\/(?:java|ecma)script/i;
  function Ft(e, t) {
  ...
  function Lt(e, t, r, i, a) {
    for (
      ...
      if (((o = e[h]), o || o === 0))
        if (m(o) === `object` && (o.nodeType || g(o)))
          S.merge(p, o.nodeType ? [o] : o);
        else if (!It.test(o)) p.push(t.createTextNode(o));
        else {
          for (
            s ||= f.appendChild(t.createElement(`div`)),
              c = (Mt.exec(o) || [``, ``])[1].toLowerCase(),
              l = Nt[c] || n,
              d = l.length;
            --d > -1;
          )
            s = s.appendChild(t.createElement(l[d]));
          ((s.innerHTML = S.htmlPrefilter(o)),
  ...
  function Bt(e, t, n, r) {
    ...
    if (typeof m == `function`)
      return e.each(function (i) {
        var a = e.eq(i);
        ((t[0] = m.call(this, i, a.html())), Bt(a, t, n, r));
      });
    if (
      f &&
      ((i = Lt(t, e[0].ownerDocument, !1, e, r)),
      (o = i.firstChild),
      i.childNodes.length === 1 && (i = o),
      o || r)
    ) {
      for (s = S.map(Q(i, `script`), Rt), c = s.length; d < f; d++)
        ((l = i),
          d !== p &&
            ((l = S.clone(l, !0, !0)), c && S.merge(s, Q(l, `script`))),
          n.call(e[d], l, d));
      if (c)
        for (u = s[s.length - 1].ownerDocument, S.map(s, zt), d = 0; d < c; d++)
          ((l = s[d]),
            Pt.test(l.type || ``) &&
              !X.get(l, `globalEval`) &&
              S.contains(u, l) &&
  ...
  S.event = {
    ...
    remove: function (e, t, n, r, i) {
      ...
      if (!(!g || !(c = g.events))) {
        ...
        S.isEmptyObject(c) && X.remove(e, `handle events`);
      }
    },
    dispatch: function (e) {
      var t,
    ...
    special: S.extend(Object.create(null), {
      load: { noBubble: !0 },
      click: {
        setup: function (e) {
          var t = this || e;
          return (
            Vt.test(t.type) && t.click && C(t, `input`) && Kt(t, `click`, !0),
            !1
          );
        },
        trigger: function (e) {
          var t = this || e;
          return (
            Vt.test(t.type) && t.click && C(t, `input`) && Kt(t, `click`),
            !0
          );
        },
        _default: function (e) {
  ...
  function Kt(e, t, n) {
    if (!n) {
      X.get(e, t) === void 0 && S.event.add(e, t, Ut);
      return;
    }
    (X.set(e, t, !1),
      S.event.add(e, t, {
        ...
        handler: function (e) {
          ...
          if (e.isTrigger & 1 && this[t]) {
            ...
            r.length &&
              (X.set(this, t, {
                value: S.event.trigger(r[0], r.slice(1), this),
              }),
              e.stopPropagation(),
              (e.isImmediatePropagationStopped = Ut));
        },
      }));
  }
  ((S.removeEvent = function (e, t, n) {
    ...
    (S.Event = function (e, t) {
      ...
      (e && e.type
        ? ((this.originalEvent = e),
          (this.type = e.type),
          (this.isDefaultPrevented = e.defaultPrevented ? Ut : Wt),
    ...
    S.each({ focus: `focusin`, blur: `focusout` }, function (e, t) {
      function n(e) {
        var t = S.event.fix(e);
        ((t.type = e.type === `focusin` ? `focus` : `blur`),
          (t.isSimulated = !0),
          t.target === t.currentTarget && X.get(this, `handle`)(t));
      }
      S.event.special[e] = {
        setup: function () {
          if ((Kt(this, e, !0), E)) this.addEventListener(t, n);
          else return !1;
        },
        trigger: function () {
          return (Kt(this, e), !0);
        ...
        teardown: function () {
          if (E) this.removeEventListener(t, n);
          else return !1;
        },
        _default: function (t) {
    ...
    S.fn.extend({
      on: function (e, t, n, r) {
        return Gt(this, e, t, n, r);
      },
      one: function (e, t, n, r) {
        return Gt(this, e, t, n, r, 1);
      },
      off: function (e, t, n) {
        var r, i;
  ...
  function Jt(e, t) {
    return (
      (C(e, `table`) &&
        C(t.nodeType === 11 ? t.firstChild : t, `tr`) &&
  ...
  function Yt(e, t) {
    ...
    if (t.nodeType === 1) {
      if (a)
        for (n in (X.remove(t, `handle events`), a))
          for (r = 0, i = a[n].length; r < i; r++) S.event.add(t, n, a[n][r]);
      Z.hasData(e) && Z.set(t, S.extend({}, Z.get(e)));
    }
  }
  function Xt(e, t, n) {
    for (var r, i = t ? S.filter(t, e) : e, a = 0; (r = i[a]) != null; a++)
      (!n && r.nodeType === 1 && S.cleanData(Q(r)),
        r.parentNode &&
          (n && At(r) && Ft(Q(r, `script`)), r.parentNode.removeChild(r)));
    return e;
  }
  (S.extend({
    ...
    clone: function (e, t, n) {
      var r,
        ...
        s = e.cloneNode(!0),
        c = At(e);
      if (E && (e.nodeType === 1 || e.nodeType === 11) && !S.isXMLDoc(e))
        for (o = Q(s), a = Q(e), r = 0, i = a.length; r < i; r++)
          C(o[r], `textarea`) && (o[r].defaultValue = a[r].defaultValue);
      if (t)
        if (n)
          for (a ||= Q(e), o ||= Q(s), r = 0, i = a.length; r < i; r++)
            Yt(a[r], o[r]);
        else Yt(e, s);
      return (
        (o = Q(s, `script`)),
        o.length > 0 && Ft(o, !c && Q(e, `script`)),
        s
      );
    },
    ...
    S.fn.extend({
      ...
      empty: function () {
        for (var e, t = 0; (e = this[t]) != null; t++)
          e.nodeType === 1 && (S.cleanData(Q(e, !1)), (e.textContent = ``));
        return this;
      },
      clone: function (e, t) {
        return (
            ...
            if (
              ...
              try {
                for (; n < r; n++)
                  ((t = this[n] || {}),
                    t.nodeType === 1 &&
                      (S.cleanData(Q(t, !1)), (t.innerHTML = e)));
                t = 0;
              } catch {}
            }
      ...
      replaceWith: function () {
        ...
        return Bt(
          ...
          function (t) {
            ...
            S.inArray(this, e) < 0 &&
              (S.cleanData(Q(this)), n && n.replaceChild(t, this));
          },
          e
        );
      },
  ...
  var Zt = RegExp(`^(` + _t + `)(?!px)[a-z%]+$`, `i`),
    Qt = /^--/;
  function $t(t) {
    var n = t.ownerDocument.defaultView;
    return ((n ||= e), n.getComputedStyle(t));
  }
  function en(e, t, n) {
    var r,
      i,
  ...
  function tn(e, t, n) {
    ...
    return (
      ...
      n &&
        ...
        i && r && (r = r.replace(O, `$1`) || void 0),
        r === `` && !At(e) && (r = S.style(e, t))),
      r === void 0 ? r : r + ``
    );
  }
  ...
  function on(e) {
    return e in rn ? e : an(e) || e;
  }
  var sn,
    cn,
    ln = _.createElement(`table`);
  function un() {
    if (!(!ln || !ln.style)) {
      var t,
        n = _.createElement(`col`),
        r = _.createElement(`tr`),
        i = _.createElement(`td`);
      if (
        ((ln.style.cssText = `position:absolute;left:-11111px;border-collapse:separate;border-spacing:0`),
      ...
      ((t = e.getComputedStyle(r)),
        (cn = E || Math.round(parseFloat(e.getComputedStyle(n).width)) === 18),
        (sn =
          Math.round(
            parseFloat(t.height) +
  ...
  var dn = { position: `absolute`, visibility: `hidden`, display: `block` },
  ...
  function mn(e, t, n, r, i, a) {
    ...
    for (; o < 4; o += 2)
      (n === `margin` && (l += S.css(e, n + yt[o], !0, i)),
        r
          ? (n === `content` && (c -= S.css(e, `padding` + yt[o], !0, i)),
            n !== `margin` &&
              (c -= S.css(e, `border` + yt[o] + `Width`, !0, i)))
          : ((c += S.css(e, `padding` + yt[o], !0, i)),
            n === `padding`
              ? (s += S.css(e, `border` + yt[o] + `Width`, !0, i))
              : (c += S.css(e, `border` + yt[o] + `Width`, !0, i))));
    return (
      !r &&
        a >= 0 &&
  ...
  function hn(e, t, n) {
    var r = $t(e),
      i = (E || n) && S.css(e, `boxSizing`, !1, r) === `border-box`,
      a = i,
      o = tn(e, t, r),
    ...
    return (
      (o === `auto` ||
        (E && i) ||
        (!p.reliableColDimensions() && C(e, `col`)) ||
        ...
        a && (o = e[s])),
      (o = parseFloat(o) || 0),
      o + mn(e, t, n || (i ? `border` : `content`), a, r, o) + `px`
    );
  }
  (S.extend({
    cssHooks: {},
    style: function (e, t, n, r) {
      if (!(!e || e.nodeType === 3 || e.nodeType === 8 || !e.style)) {
        var i,
          ...
          l = e.style;
        if (
          (c || (t = on(s)), (o = S.cssHooks[t] || S.cssHooks[s]), n !== void 0)
        ) {
          if (
            ((a = typeof n),
            a === `string` &&
          ...
          return o && `get` in o && (i = o.get(e, !1, r)) !== void 0 ? i : l[t];
      }
    },
    css: function (e, t, n, r) {
      ...
      return (
        ...
        i === void 0 && (i = tn(e, t, r)),
        i === `normal` && t in fn && (i = fn[t]),
        n === `` || n
          ? ((a = parseFloat(i)), n === !0 || isFinite(a) ? a || 0 : i)
          : i
      );
    },
  }),
    S.each([`height`, `width`], function (e, t) {
      S.cssHooks[t] = {
        ...
        set: function (e, n, r) {
          var i,
            a = $t(e),
            o = r && S.css(e, `boxSizing`, !1, a) === `border-box`,
            s = r ? mn(e, t, r, o, a) : 0;
          return (
            s &&
              (i = vt.exec(n)) &&
      ...
      ((S.cssHooks[e + t] = {
        expand: function (n) {
          for (
            ...
            i[e + yt[r] + t] = a[r] || a[r - 2] || a[0];
          return i;
        },
      }),
        e !== `margin` && (S.cssHooks[e + t].set = pn));
    }),
    S.fn.extend({
      css: function (e, t) {
        return z(
    ...
    (gn.prototype = {
      ...
      run: function (e) {
        ...
        return (
          ...
          n && n.set ? n.set(this) : gn.propHooks._default.set(this),
          this
        );
      },
    }),
      ...
      _default: {
        ...
        set: function (e) {
          S.fx.step[e.prop]
            ? S.fx.step[e.prop](e)
            : e.elem.nodeType === 1 &&
                (S.cssHooks[e.prop] || e.elem.style[on(e.prop)] != null)
  ...
  function xn() {
    vn &&
      (_.hidden === !1 && e.requestAnimationFrame
        ? e.requestAnimationFrame(xn)
        : e.setTimeout(xn, 13),
      S.fx.tick());
  }
  function Sn() {
  ...
  function Cn(e, t) {
    var n,
      ...
      i = { height: e };
    for (t = +!!t; r < 4; r += 2 - t)
      ((n = yt[r]), (i[`margin` + n] = i[`padding` + n] = e));
    return (t && (i.opacity = i.width = e), i);
  }
  function wn(e, t, n) {
    for (
      var r,
        i = (Dn.tweeners[t] || []).concat(Dn.tweeners[`*`]),
        a = 0,
        o = i.length;
      a < o;
      a++
      ...
      p))
        (c ||
          (g
            ...
            : (g = X.set(e, `fxshow`, { display: l })),
          a && (g.hidden = !h),
          h && kt([e], !0),
          f.done(function () {
            for (r in (h || kt([e]), X.remove(e, `fxshow`), p))
              S.style(e, r, p[r]);
          })),
          (c = wn(h ? g[r] : 0, r, f)),
          r in g ||
  ...
  function Dn(e, t, n) {
    var r,
      ...
      u = l.props;
    for (En(u, l.opts.specialEasing); a < o; a++)
      if (((r = Dn.prefilters[a].call(l, e, u, l.opts)), r))
        return (
    ...
    return (
      S.map(u, wn, l),
      typeof l.opts.start == `function` && l.opts.start.call(e, l),
      l
  ...
  ((S.Animation = S.extend(Dn, {
    ...
    tweener: function (e, t) {
      typeof e == `function` ? ((t = e), (e = [`*`])) : (e = e.match(B));
      for (var n, r = 0, i = e.length; r < i; r++)
        ((n = e[r]),
          (Dn.tweeners[n] = Dn.tweeners[n] || []),
          Dn.tweeners[n].unshift(t));
    },
    prefilters: [Tn],
    prefilter: function (e, t) {
      t ? Dn.prefilters.unshift(e) : Dn.prefilters.push(e);
    },
  })),
    (S.speed = function (e, t, n) {
      var r =
        e && typeof e == `object`
          ? S.extend({}, e)
          : {
              complete: n || t || (typeof e == `function` && e),
              duration: e,
              easing: (n && t) || (t && typeof t != `function` && t),
            };
      return (
        S.fx.off
          ? (r.duration = 0)
        ...
        (r.old = r.complete),
        (r.complete = function () {
          (typeof r.old == `function` && r.old.call(this),
    ...
    (S.fx.tick = function () {
      var e,
        t = 0,
        n = S.timers;
      for (_n = Date.now(); t < n.length; t++)
        ((e = n[t]), !e() && n[t] === e && n.splice(t--, 1));
      (n.length || S.fx.stop(), (_n = void 0));
    }),
      ...
      propHooks: {
        tabIndex: {
          get: function (e) {
            ...
            return t
              ? parseInt(t, 10)
              : On.test(e.nodeName) || (kn.test(e.nodeName) && e.href)
                ? 0
                : -1;
          },
        },
  ...
  function Mn(e) {
    return Array.isArray(e) ? e : (typeof e == `string` && e.match(B)) || [];
  }
  (S.fn.extend({
    addClass: function (e) {
      var t, n, r, i, a, o;
      return typeof e == `function`
        ? this.each(function (t) {
            S(this).addClass(e.call(this, t, jn(this)));
          })
        : ((t = Mn(e)),
          t.length
            ? this.each(function () {
    ...
    removeClass: function (e) {
      ...
      return typeof e == `function`
        ? this.each(function (t) {
            S(this).removeClass(e.call(this, t, jn(this)));
          })
        : arguments.length
          ? ((t = Mn(e)),
            t.length
    ...
    toggleClass: function (e, t) {
      ...
      return typeof e == `function`
        ? this.each(function (n) {
            S(this).toggleClass(e.call(this, n, jn(this), t), t);
          })
        : typeof t == `boolean`
          ? t
            ? this.addClass(e)
    ...
    S.extend({
      valHooks: {
        select: {
          ...
          set: function (e, t) {
            for (
              var n, r, i = e.options, a = S.makeArray(t), o = i.length;
              o--;
            )
              ((r = i[o]),
                (r.selected = S.inArray(S(r).val(), a) > -1) && (n = !0));
    ...
    E &&
      (S.valHooks.option = {
        get: function (e) {
          return e.getAttribute(`value`) ?? An(S.text(e));
        },
      }),
    ...
    trigger: function (t, n, r, i) {
      ...
      if (
        ...
        !(r.nodeType === 3 || r.nodeType === 8) &&
          !Nn.test(g + S.event.triggered) &&
          (g.indexOf(`.`) > -1 &&
            ((v = g.split(`.`)), (g = v.shift()), v.sort()),
          (l = g.indexOf(`:`) < 0 && `on` + g),
          (t = t[S.expando] ? t : new S.Event(g, typeof t == `object` && t)),
          (t.isTrigger = i ? 2 : 3),
          (t.namespace = v.join(`.`)),
        ...
        if (!i && !f.noBubble && !h(r)) {
          for (
            c = f.delegateType || g, Nn.test(c + g) || (o = o.parentNode);
            o;
            o = o.parentNode
          )
            (m.push(o), (s = o));
        ...
        return (
          ...
          !i &&
            ...
            (!f._default || f._default.apply(m.pop(), n) === !1) &&
            dt(r) &&
            l &&
            typeof r[g] == `function` &&
            !h(r) &&
            ...
            s && (r[l] = null),
            (S.event.triggered = g),
            t.isPropagationStopped() && p.addEventListener(g, Pn),
            r[g](),
            t.isPropagationStopped() && p.removeEventListener(g, Pn),
  ...
  function Hn(e, t, n, r) {
    ...
    if (Array.isArray(t))
      S.each(t, function (t, i) {
        n || Rn.test(e)
          ? r(e, i)
          : Hn(e + `[` + (typeof i == `object` && i ? t : ``) + `]`, i, n, r);
      });
    else if (!n && m(t) === `object`)
      for (i in t) Hn(e + `[` + i + `]`, t[i], n, r);
    else r(e, t);
  }
        ...
        return this.map(function () {
          ...
          .filter(function () {
            ...
            return (
              this.name &&
              !S(this).is(`:disabled`) &&
              Vn.test(this.nodeName) &&
              !Bn.test(e) &&
              (this.checked || !Vt.test(e))
            );
          })
          .map(function (e, t) {
            var n = S(this).val();
...
`
  ...
  (S.extend({
    ...
    ajaxSetup: function (e, t) {
      return t ? nr(nr(e, S.ajaxSettings), t) : nr(S.ajaxSettings, e);
    },
    ajaxPrefilter: er(Xn),
    ajaxTransport: er(Zn),
    ajax: function (t, n) {
      ...
      if (
        ...
        try {
          ((c.href = p.url),
            (c.href = c.href),
            (p.crossDomain =
              $n.protocol + `//` + $n.host != c.protocol + `//` + c.host));
        } catch {
          p.crossDomain = !0;
        }
      }
      ...
      p.hasContent
        ? p.data &&
          ...
          (p.contentType || ``).indexOf(`application/x-www-form-urlencoded`) ===
            0 &&
          (p.data = p.data.replace(Un, `+`))
        : ((f = p.url.slice(i.length)),
          p.data &&
            (p.processData || typeof p.data == `string`) &&
            ((i += (Ln.test(i) ? `&` : `?`) + p.data), delete p.data),
          p.cache === !1 &&
            ((i = i.replace(Gn, `$1`)),
            (f = (Ln.test(i) ? `&` : `?`) + `_=` + In.guid++ + f)),
          (p.url = i + f)),
      p.ifModified &&
        (S.lastModified[i] &&
      ...
      w.setRequestHeader(
        ...
        p.dataTypes[0] && p.accepts[p.dataTypes[0]]
          ? p.accepts[p.dataTypes[0]] +
              (p.dataTypes[0] === `*` ? `` : `, ` + Qn + `; q=0.01`)
          : p.accepts[`*`]
      ),
      p.headers))
        w.setRequestHeader(d, p.headers[d]);
      if (p.beforeSend && (p.beforeSend.call(m, w, p) === !1 || l))
        return w.abort();
      if (
        ((C = `abort`),
        v.add(p.complete),
        ...
        if (((w.readyState = 1), u && h.trigger(`ajaxSend`, [w, p]), l))
          return w;
        p.async &&
          p.timeout > 0 &&
          ...
          d
            ? (p.ifModified &&
              ...
              t === 204 || p.type === `HEAD`
                ...
                : t === 304
                  ? (C = `notmodified`)
                  : ((C = b.state), (f = b.data), (_ = b.error), (d = !_)))
            : ((_ = C), (t || !C) && ((C = `error`), t < 0 && (t = 0))),
          (w.status = t),
          (w.statusText = (n || C) + ``),
          d ? g.resolveWith(m, [f, C, w]) : g.rejectWith(m, [w, C, _]),
          w.statusCode(y),
          (y = void 0),
          u && h.trigger(d ? `ajaxSuccess` : `ajaxError`, [w, p, d ? f : _]),
          v.fireWith(m, [w, C]),
          u &&
    ...
    S.fn.extend({
      wrapAll: function (e) {
        ...
        return (
          this[0] &&
            (typeof e == `function` && (e = e.call(this[0])),
    ...
    return {
      send: function (n, r) {
        var i,
          a = e.xhr();
        if (
          (a.open(e.type, e.url, e.async, e.username, e.password), e.xhrFields)
        )
        ...
        ((t = function (e) {
          return function () {
            t &&
              ((t = a.onload = a.onerror = a.onabort = a.ontimeout = null),
              e === `abort`
                ? a.abort()
                : e === `error`
                  ? r(a.status, a.statusText)
                  : r(
                      ar[a.status] || a.status,
                      a.statusText,
          ...
          (a.onload = t()),
          (a.onabort = a.onerror = a.ontimeout = t(`error`)),
          (t = t(`abort`)));
        try {
  ...
  function or(e) {
    return (
      e.scriptAttrs ||
      (!e.headers &&
        (e.crossDomain || (e.async && S.inArray(`json`, e.dataTypes) < 0)))
    );
  }
  (S.ajaxSetup({
    accepts: {
    ...
    S.ajaxPrefilter(`script`, function (e) {
      (e.cache === void 0 && (e.cache = !1), or(e) && (e.type = `GET`));
    }),
  ...
  (S.ajaxSetup({
    ...
    jsonpCallback: function () {
      var e = sr.pop() || S.expando + `_` + In.guid++;
      return ((this[e] = !0), e);
    },
  }),
    S.ajaxPrefilter(`jsonp`, function (t, n, r) {
      var i,
        a,
        o,
        s =
      ...
      return (
        (i = t.jsonpCallback =
          typeof t.jsonpCallback == `function`
            ? t.jsonpCallback()
            : t.jsonpCallback),
        s
          ? (t[s] = t[s].replace(cr, `$1` + i))
          : t.jsonp !== !1 &&
        ...
        r.always(function () {
          (a === void 0 ? S(e).removeProp(i) : (e[i] = a),
            t[i] && ((t.jsonpCallback = n.jsonpCallback), sr.push(i)),
            o && typeof a == `function` && a(o[0]),
            (o = a = void 0));
        }),
        `script`
      );
    }),
    S.ajaxPrefilter(function (t, n) {
      (typeof t.data != `string` &&
    ...
    (S.parseHTML = function (t, n, r) {
      if (typeof t != `string` && !qe(t + ``)) return [];
      typeof n == `boolean` && ((r = n), (n = !1));
      var i, a;
      return (
        (n ||= new e.DOMParser().parseFromString(``, `text/html`)),
        (i = Ke.exec(t)),
        (a = !r && []),
        i
          ? [n.createElement(i[1])]
    ...
    (S.fn.load = function (e, t, n) {
      var r,
        ...
        s = e.indexOf(` `);
      return (
        s > -1 && ((r = An(e.slice(s))), (e = e.slice(0, s))),
        typeof t == `function`
          ? ((n = t), (t = void 0))
    ...
    (S.offset = {
      setOffset: function (e, t, n) {
        ...
        (u === `static` && (e.style.position = `relative`),
          ...
          typeof t == `function` && (t = t.call(e, n, S.extend({}, s))),
        ...
        if (this[0]) {
          ...
          if (S.css(r, `position`) === `fixed`) t = r.getBoundingClientRect();
            ...
            for (
              ...
              e && e !== n.documentElement && S.css(e, `position`) === `static`;
            )
    ...
    (S.expr[`:`] = S.expr.filters = S.expr.pseudos),
...
var jQuery$2,
  init_jquery_module = __esmMin(() => {
    jQuery$2 = jQueryFactory$1(window, !0);
  }),
  init_jquery_tmpl = __esmMin(() => {
    (function (e) {
      typeof define == `function` && define.amd
        ? define([`jquery`], e)
        : e(jQuery);
      ...
      function d(t, n, r, o) {
        ...
        return (
          t && e.extend(s, t, { nodes: [], parent: n }),
          r &&
            ((s.tmpl = r),
            (s._ctnt = s._ctnt || s.tmpl(e, s)),
            (s.key = ++c),
            ((u.length ? a : i)[c] = s)),
          s
        );
          ...
          e.fn[t] = function (r) {
            ...
            if (
              ...
              for (u = 0, d = s.length; u < d; u++)
                ((l = u),
                  (c = (u > 0 ? this.clone(!0) : this).get()),
                  e(s[u])[n](c),
                  (a = a.concat(c)));
              ((l = 0), (a = this.pushStack(a, t, s.selector)));
            }
            return ((f = o), (o = null), e.tmpl.complete(f), a);
          };
        }
      ),
        e.fn.extend({
          ...
          domManip: function (n, r, a, s) {
            if (n[0] && e.isArray(n[0])) {
              for (
            ...
            return ((l = 0), o || e.tmpl.complete(i), this);
          },
        }),
        e.extend({
          tmpl: function (t, n, r, o) {
            var c,
              l = !o;
            if (l)
              ((o = s), (t = e.template[t] || e.template(null, t)), (a = {}));
            else if (!t)
              return (
                (t = o.tmpl),
                (i[o.key] = o),
            ...
            return t
              ? (typeof n == `function` && (n = n.call(o || {})),
                r && r.wrapped && h(r, r.wrapped),
                (c = e.isArray(n)
                  ? e.map(n, function (e) {
                      return e ? d(r, o, t, e) : null;
                    })
                  : [d(r, o, t, n)]),
                l ? e(f(o, null, c)) : c)
              : [];
          ...
          template: function (t, n) {
            return n
              ? (typeof n == `string`
                ...
                n.nodeType &&
                  (n = e.data(n, `tmpl`) || e.data(n, `tmpl`, m(n.innerHTML))),
                typeof t == `string` ? (e.template[t] = n) : n)
              : t
                ? typeof t == `string`
                  ? e.template[t] || e.template(null, r.test(t) ? t : e(t))
                  : e.template(null, t)
                : null;
          },
          encode: function (e) {
      ...
      function h(t, n) {
        t._wrap = f(
          t,
          !0,
          e.isArray(n) ? n : [r.test(n) ? n : e(n).html()]
        ).join(``);
      }
      function g(e) {
      ...
      function v(t) {
        ...
        for (f = 0, p = t.length; f < p; f++)
          if ((o = t[f]).nodeType === 1) {
            for (s = o.getElementsByTagName(`*`), m = s.length - 1; m >= 0; m--)
              h(s[m]);
            h(o);
          }
        function h(t) {
          var o,
            ...
            p,
            m;
          if ((m = t.getAttribute(n))) {
            for (
              ;
              s.parentNode &&
              (s = s.parentNode).nodeType === 1 &&
              !(o = s.getAttribute(n));
            );
            (o !== m &&
              ((s = s.parentNode
          ...
          function h(e) {
            ((e += r),
              (p = u[e] = u[e] || d(p, i[p.parent.key + r] || p.parent)));
          }
        }
      }
      function y(e, t, n, r) {
      ...
      function S(t, n) {
        ...
        return e.map(
          ...
          function (e) {
            return n ? e.innerText || e.textContent : e.outerHTML || _(e);
          }
        );
      }
      function C() {
...
function jQueryFactory(e, t) {
  e.migrateVersion = `4.0.2`;
  function n(e, t) {
    var n,
      r = /^(\d+)\.(\d+)\.(\d+)/,
      i = r.exec(e) || [],
  ...
  ((e.migrateDisablePatches = function () {
    var e;
    for (e = 0; e < arguments.length; e++) i[arguments[e]] = !0;
  }),
    (e.migrateEnablePatches = function () {
      var e;
      for (e = 0; e < arguments.length; e++) delete i[arguments[e]];
    }),
    ...
    (function () {
      ((!e || !r(`4.0.0`) || r(`5.0.0`)) &&
        t.console.log(`JQMIGRATE: jQuery 4.x REQUIRED`),
        e.migrateMessages &&
  ...
  ((e.migrateMessages = []),
    e.migrateDeduplicateMessages === void 0 &&
      (e.migrateDeduplicateMessages = !0),
    e.migrateTrace === void 0 && (e.migrateTrace = !0),
    (e.migrateReset = function () {
      ((a = Object.create(null)), (e.migrateMessages.length = 0));
    }));
  function o(n, r, i) {
    var o = t.console;
    e.migrateIsPatchEnabled(n) &&
      (!e.migrateDeduplicateMessages || !a[r]) &&
      ((a[r] = !0),
      e.migrateMessages.push(i.toUpperCase() + `: ` + r + ` [` + n + `]`),
      o[i] &&
        !e.migrateMute &&
        (o[i](`JQMIGRATE: ` + r),
        e.migrateTrace && o.trace(`JQMIGRATE: ` + r)));
  }
  function s(e, t) {
    o(e, t, `warn`);
  }
  ...
  function l(t, n, r, i, a, o) {
    ...
    Object.defineProperty(t, n, {
      ...
      enumerable: !0,
      get: function () {
        return e.migrateIsPatchEnabled(i) ? (a && o(i, a), r) : s;
      },
      set: function (t) {
        (e.migrateIsPatchEnabled(i) && a && o(i, a), (s = r = t));
      },
    });
  }
  ...
  function d(e, t, n, r, i) {
    if (!i) throw Error(`No warning message provided`);
    l(e, t, n, r, i, c);
  }
  function f(e, t, n, r) {
    l(e, t, n, r);
  ...
  function p(e, t, n, r, i, a) {
    function o() {
      return (i && a(r, i), n.apply(this, arguments));
    }
    l(e, t, o, r);
  }
  ...
  function h(e, t, n, r, i) {
    if (!i) throw Error(`No info message provided`);
    return p(e, t, n, r, i, c);
  }
  function g(e, t, n, r) {
    return p(e, t, n, r);
  }
  t.document.compatMode === `BackCompat` &&
    s(`quirks`, `jQuery is not compatible with Quirks Mode`);
  var _ = [],
    v = _.push,
    y = _.sort,
    b = _.splice,
  ...
  (m(
    ...
    m(
      ...
      e.uniqueSort,
      `unique`,
      `jQuery.unique() is removed; use jQuery.uniqueSort()`
    ),
    m(
      e,
      `trim`,
      function (e) {
        return e == null ? `` : (e + ``).replace(w, `$1`);
      },
      `trim`,
    ...
    m(
      ...
      function (e) {
        return e == null
          ? e + ``
          : typeof e == `object`
            ? x[Object.prototype.toString.call(e)] || `object`
            : typeof e;
      },
      `type`,
    ...
    m(e, `now`, Date.now, `now`, `jQuery.now() is removed; use Date.now()`));
  function T(e, t) {
    return t.toUpperCase();
  }
  (m(
    ...
    `camelCase`,
    function (e) {
      return e.replace(S, `ms-`).replace(C, T);
    },
    `camelCase`,
    `jQuery.camelCase() is removed`
  ),
    h(e, `proxy`, e.proxy, `proxy`, `jQuery.proxy() is deprecated`),
    m(
      e.fn,
      `push`,
      v,
  ...
  if (
    (g(
      ...
      function (t, n) {
        var r,
          i =
            e.expr.pseudos[t] ||
            e.expr.setFilters[t.toLowerCase()] ||
            e.error(
              `Syntax error, unrecognized expression: unsupported pseudo: ` + t
            );
        return i[e.expando]
          ? i(n)
          : i.length > 1
            ? (c(
                ...
                `Pseudos with multiple arguments are deprecated; use jQuery.expr.createPseudo()`
              ),
              (r = [t, t, ``, n]),
    ...
    typeof Proxy < `u` &&
      e.each([`pseudos`, `setFilters`], function (t, n) {
        e.expr[n] = new Proxy(e.expr[n], {
          set: function (t, n, r) {
            return (
              typeof r == `function` &&
                !r[e.expando] &&
    ...
    var D = [],
      O = `migrate-` + Date.now(),
      k = e.ajaxSettings.jsonpCallback,
      A = /(=)\?(?=&|$)|\?\?/,
      ee = /\?/;
    (e.ajaxSetup({
      jsonpCallback: function () {
        if (e.migrateIsPatchEnabled(`jsonp-promotion`)) {
          var t = D.pop() || e.expando + `_` + O++;
          return ((this[t] = !0), t);
        } else return k.apply(this, arguments);
      },
    }),
      e.ajaxPrefilter(`+json`, function (n, r, i) {
        if (e.migrateIsPatchEnabled(`jsonp-promotion`)) {
          var a,
            o,
            c,
            l =
              ...
              (A.test(n.url)
                ...
                : typeof n.data == `string` &&
                  ...
                  A.test(n.data) &&
                  `data`);
          if (l || n.dataTypes[0] === `jsonp`)
            return (
              s(`jsonp-promotion`, `JSON-to-JSONP auto-promotion is removed`),
              (a = n.jsonpCallback =
                typeof n.jsonpCallback == `function`
                  ? n.jsonpCallback()
                  : n.jsonpCallback),
              l
                ? (n[l] = n[l].replace(A, `$1` + a))
                : n.jsonp !== !1 &&
                  (n.url += (ee.test(n.url) ? `&` : `?`) + n.jsonp + `=` + a),
              ...
              i.always(function () {
                (o === void 0 ? e(t).removeProp(a) : (t[a] = o),
                  n[a] && ((n.jsonpCallback = r.jsonpCallback), D.push(a)),
                  c && typeof o == `function` && o(c[0]),
                  (c = o = void 0));
              }),
              `script`
            );
      ...
      e.migrateDisablePatches(`jsonp-promotion`));
  }
  var j = e.attr,
    M = e.fn.toggleClass,
    N = `checked|selected|async|autofocus|autoplay|controls|defer|disabled|hidden|ismap|loop|multiple|open|readonly|required|scoped`,
    P = RegExp(`^(?:` + N + `)$`, `i`),
    F = { hidden: [`until-found`] };
  (e.each(N.split(`|`), function (t, n) {
    ...
    e.attrHooks[n] = {
      get:
        ...
        function (t) {
          var r;
          return e.migrateIsPatchEnabled(`boolean-attributes`) &&
            ((r = t.getAttribute(n)),
            r !== n &&
              r != null &&
              (F[n] || []).indexOf(String(r).toLowerCase()) === -1)
            ? (s(
                `boolean-attributes`,
                `Boolean attribute '` +
                  n +
      ...
      set:
        ...
        function (t, n, r) {
          if (
            e.migrateIsPatchEnabled(`boolean-attributes`) &&
            n !== r &&
            (F[r] || []).indexOf(String(n).toLowerCase()) === -1
          )
            return (
              n !== !1 &&
                s(
              ...
              n === !1 ? e.removeAttr(t, r) : t.setAttribute(r, r),
              r
            );
        },
    };
    ...
    g(
      ...
      function (t, n, r) {
        var i = t.nodeType;
        if (i === 3 || i === 8 || i === 2 || t.getAttribute === void 0)
          return j.apply(this, arguments);
        if (r === !1 && n.toLowerCase().indexOf(`aria-`) !== 0 && !P.test(n)) {
          (s(
            `attr-false`,
            `Setting the non-ARIA non-boolean attribute '` + n + `' to false`
          ),
            e.attr(t, n, `false`));
          return;
        }
    ...
    g(
      ...
      `toggleClass`,
      function (t) {
        return t !== void 0 && typeof t != `boolean`
          ? M.apply(this, arguments)
          : (s(
              `toggleClass-bool`,
              `jQuery.fn.toggleClass( [ boolean ] ) is removed`
            ),
            this.each(function () {
              ...
              (n && e.data(this, `__className__`, n),
                this.setAttribute &&
                  this.setAttribute(
                    `class`,
                    n || t === !1 ? `` : e.data(this, `__className__`) || ``
                  ));
            }));
      },
      `toggleClass-bool`
        ...
        Object.defineProperty(o, e, {
          get: function () {
            return (
              ...
              e + `__cache` in o ? o[e + `__cache`] : Object.prototype[e]
            );
          },
          set: function (t) {
            (s(
              r,
              `Setting properties from ` +
                i +
                ` inherited from Object.prototype is removed`
            ),
              (o[e + `__cache`] = t));
  ...
  (typeof Proxy < `u` &&
    (e.cssProps = new Proxy(e.cssProps || {}, {
      set: function () {
        return (
          s(`cssProps`, `jQuery.cssProps is removed`),
          Reflect.set.apply(this, arguments)
        );
      },
    })),
    ...
    typeof Proxy < `u`
      ? (e.cssNumber = new Proxy(ne, {
          get: function () {
            return (
              s(`css-number`, `jQuery.cssNumber is deprecated`),
      ...
      : (e.cssNumber = ne));
  function R(e) {
    return re.test(e) && ie.test(e[0].toUpperCase() + e.slice(1));
  }
  ((te = e.fn.css),
    g(
      e.fn,
        ...
        return t && typeof t == `object` && !Array.isArray(t)
          ...
          : (typeof n == `number` &&
              ...
              !R(r) &&
                ...
                s(
                  `css-number`,
                  `Auto-appending 'px' to number-typed values for jQuery.fn.css( "` +
                    t +
                    `", value ) is removed`
                )),
  ...
  function ae(e, t) {
    var n = t.warningId,
      r = t.apiName,
      i = t.isInstanceMethod;
    return function () {
      var t = e.apply(this, arguments);
      return (
        arguments.length !== +!i ||
          t === void 0 ||
          L(t, { warningId: n, apiName: r }),
        t
      );
    };
  }
  if (
    ...
    var oe = e.fx.interval,
      se = `jQuery.fx.interval is removed`;
    Object.defineProperty(e.fx, 'interval', {
      configurable: !0,
      enumerable: !0,
      get: function () {
        return (
          t.document.hidden || s(`fx-interval`, se),
          e.migrateIsPatchEnabled(`fx-interval`) && oe === void 0 ? 13 : oe
        );
      },
      set: function (e) {
        (s(`fx-interval`, se), (oe = e));
      },
    });
  }
  var ce = e.event.add;
  ((e.event.props = []),
    ...
    h(e.fn, `hover`, e.fn.hover, `hover`, `jQuery.fn.hover() is deprecated`),
    u(e.event, `global`, {}, `event-global`, `jQuery.event.global is removed`),
    f(
      e.event,
      `special`,
      L(e.extend(Object.create(null), e.event.special), {
  ...
  var le =
    ...
    z = function (e) {
      var t = e.replace(le, `<$1></$2>`);
      t !== e &&
        ue(e) !== ue(t) &&
        s(
          `self-closed-tags`,
          `HTML tags must be properly nested and closed: ` + e
        );
    };
  if (
    (g(
    ...
    (g(
      ...
      (e.Deferred.exceptionHook = de.exceptionHook),
      (e.Deferred.getErrorHook = de.getErrorHook),
      Object.defineProperty(e.Deferred, 'getStackHook', {
        configurable: !0,
        enumerable: !0,
        get: function () {
          return e.migrateIsPatchEnabled(`deferred-getStackHook`)
            ? (s(
        ...
        set: function (t) {
          e.migrateIsPatchEnabled(`deferred-getStackHook`)
            ? e.Deferred.getErrorHook !== t &&
              (s(
                `deferred-getStackHook`,
                `jQuery.Deferred.getStackHook is removed; use jQuery.Deferred.getErrorHook`
              ),
...
var jQuery$1,
  init_jquery_migrate_module = __esmMin(() => {
    (init_jquery_module(), jQueryFactory(jQuery$2, window));
  }),
  init_jquery_blockUI = __esmMin(() => {
    (function () {
      function e(e) {
        ...
        var i = e.isFunction(document.createElement(`div`).style.setExpression);
          ...
          (e.growlUI = function (t, n, r, i) {
            ...
            var o = function (t) {
              ((t ||= {}),
                e.blockUI({
                  message: a,
                  fadeIn: t.fadeIn === void 0 ? 700 : t.fadeIn,
                  fadeOut: t.fadeOut === void 0 ? 1e3 : t.fadeOut,
                  timeout: t.timeout === void 0 ? r : t.timeout,
                  centerY: !1,
                  showOverlay: !1,
                  onUnblock: i,
        ...
        function s(s, l) {
          var d,
            h,
            g = s == window,
            _ = l && l.message !== void 0 ? l.message : void 0;
          if (
            ((l = e.extend({}, e.blockUI.defaults, l || {})),
            !(l.ignoreIfBlocked && e(s).data(`blockUI.isBlocked`)))
          ) {
            if (
              ((l.overlayCSS = e.extend(
                {},
                e.blockUI.defaults.overlayCSS,
                l.overlayCSS || {}
              )),
              (d = e.extend({}, e.blockUI.defaults.css, l.css || {})),
              l.onOverlayClick && (l.overlayCSS.cursor = `pointer`),
              (h = e.extend(
                {},
                e.blockUI.defaults.themedCSS,
                l.themedCSS || {}
              )),
              (_ = _ === void 0 ? l.message : _),
              g && a && c(window, { fadeOut: 0 }),
              _ && typeof _ != `string` && (_.parentNode || _.jquery))
            ) {
              var v = _.jquery ? _[0] : _,
                y = {};
              (e(s).data(`blockUI.history`, y),
                (y.el = v),
            ...
            e(s).data(`blockUI.onUnblock`, l.onUnblock);
            var b = l.baseZ,
              x =
                n || l.forceIframe
                  ? e(
            ...
            (l.theme && g
              ...
              _ &&
                (l.theme
                  ? (C.css(h), C.addClass(`ui-widget-content`))
                  : C.css(d)),
              l.theme || S.css(l.overlayCSS),
              S.css(`position`, g ? `fixed` : `absolute`),
              (n || l.forceIframe) && x.css(`opacity`, 0));
            var T = [x, S, C],
              E = e(g ? `body` : s);
            (e.each(T, function () {
              this.appendTo(E);
              ...
              l.theme &&
                l.draggable &&
                e.fn.draggable &&
                C.draggable({ handle: `.ui-dialog-titlebar`, cancel: `li` }));
            var D =
              i &&
              (!e.support.boxModel ||
                e(`object,embed`, g ? null : s).length > 0);
            if (r || D) {
              if (
                (g &&
                  l.allowBodyStretch &&
                ...
                (r || !e.support.boxModel) && !g)
              )
                var O = m(s, `borderTopWidth`),
                  k = m(s, `borderLeftWidth`),
                  A = O ? `(0 - ` + O + `)` : 0,
                  ee = k ? `(0 - ` + k + `)` : 0;
              e.each(T, function (e, t) {
                ...
                if (((n.position = `absolute`), e < 2))
                  ...
                  var r =
                    ...
                    (l.css && l.css.top ? parseInt(l.css.top, 10) : 0) +
                    `) + "px"`;
            ...
            if (
              (_ &&
                (l.theme ? C.find(`.ui-widget-content`).append(_) : C.append(_),
                (_.jquery || _.nodeType) && e(_).show()),
              (n || l.forceIframe) && l.showOverlay && x.show(),
              l.fadeIn)
            ) {
              var j = l.onBlock ? l.onBlock : t,
                M = l.showOverlay && !_ ? j : t,
                N = _ ? j : t;
              (l.showOverlay && S._fadeIn(l.fadeIn, M),
                _ && C._fadeIn(l.fadeIn, N));
            } else
              (l.showOverlay && S.show(),
                _ && C.show(),
                l.onBlock && l.onBlock.bind(C)());
            if (
              (u(1, s, l),
              g
                ? ((a = C[0]),
                  (o = e(l.focusableElements, a)),
                  l.focusInput && setTimeout(f, 20))
                : p(C[0], l.centerX, l.centerY),
              l.timeout)
            ) {
              var P = setTimeout(function () {
                g ? e.unblockUI(l) : e(s).unblock(l);
              }, l.timeout);
        ...
        function c(t, n) {
          ...
          var f = i
            ...
            : s.find(`>.blockUI`);
          (n.cursorReset &&
            (f.length > 1 && (f[1].style.cursor = n.cursorReset),
            f.length > 2 && (f[2].style.cursor = n.cursorReset)),
            i && (a = o = null),
            n.fadeOut
              ? ((r = f.length),
                f.stop().fadeOut(n.fadeOut, function () {
                  --r === 0 && l(f, c, n, t);
                }))
              : l(f, c, n, t));
        }
        function l(t, n, r, i) {
          ...
          if (!a.data(`blockUI.isBlocked`)) {
            ...
            var o = e(document.body),
              s = o.width(),
              c = o[0].style.width;
            (o.width(s - 1).width(s), (o[0].style.width = c));
          }
        }
        function u(t, n, r) {
          var i = n == window,
            o = e(n);
          if (
            !(!t && ((i && !a) || (!i && !o.data(`blockUI.isBlocked`)))) &&
        ...
        function d(t) {
          ...
          var s = t.data,
            c = e(t.target);
          return (
            c.hasClass(`blockOverlay`) &&
              s.onOverlayClick &&
              s.onOverlayClick(t),
            c.parents(`div.` + s.blockMsgClass).length > 0
              ? !0
              : c.parents().children().filter(`div.blockUI`).length === 0
          );
        }
        function f(e) {
          if (o) {
        ...
        function p(e, t, n) {
          var r = e.parentNode,
            i = e.style,
            a = (r.offsetWidth - e.offsetWidth) / 2 - m(r, `borderLeftWidth`),
            o = (r.offsetHeight - e.offsetHeight) / 2 - m(r, `borderTopWidth`);
          (t && (i.left = a > 0 ? a + `px` : `0`),
            n && (i.top = o > 0 ? o + `px` : `0`));
        }
        function m(t, n) {
...
export {
  jQuery$2 as a,
  init_jquery_module as i,
  init_jquery_migrate_module as n,
  init_scriptaculous as o,
  init_jquery_tmpl as r,
  require_prototype as s,
  init_jquery_blockUI as t,
};
