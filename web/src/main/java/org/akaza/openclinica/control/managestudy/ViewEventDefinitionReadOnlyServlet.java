...
public class ViewEventDefinitionReadOnlyServlet extends ViewEventDefinitionServlet {
    ...
    public void processRequest() throws Exception {
        ...
        StudyEventDefinitionDAO sdao = org.akaza.openclinica.control.SpringServletAccess.getDao(context, StudyEventDefinitionDAO.class);
        ...
        EventDefinitionCRFDAO edao = org.akaza.openclinica.control.SpringServletAccess.getDao(context, EventDefinitionCRFDAO.class);
        ArrayList eventDefinitionCRFs = (ArrayList) edao.findAllByDefinition(this.currentStudy, sed.getId());

        CRFVersionDAO cvdao = org.akaza.openclinica.control.SpringServletAccess.getDao(context, CRFVersionDAO.class);
        CRFDAO cdao = org.akaza.openclinica.control.SpringServletAccess.getDao(context, CRFDAO.class);
        ...
        StudyParameterValueDAO spvdao = org.akaza.openclinica.control.SpringServletAccess.getDao(context, StudyParameterValueDAO.class);    
