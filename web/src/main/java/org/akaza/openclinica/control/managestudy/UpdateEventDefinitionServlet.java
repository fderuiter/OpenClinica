...
public class UpdateEventDefinitionServlet extends SecureController {
    ...
    private void submitDefinition() {
        ...
        StudyEventDefinitionBean sed = (StudyEventDefinitionBean) session.getAttribute("definition");
        StudyEventDefinitionDAO edao = org.akaza.openclinica.control.SpringServletAccess.getDao(getServletContext(), StudyEventDefinitionDAO.class);
        if (sed !=null)
        ...
        EventDefinitionCRFDAO cdao = org.akaza.openclinica.control.SpringServletAccess.getDao(getServletContext(), EventDefinitionCRFDAO.class);
