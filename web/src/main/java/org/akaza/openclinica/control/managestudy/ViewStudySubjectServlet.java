...
//        mayAccess();
    ...
    public void processRequest() throws Exception {
        ...
        StudySubjectDAO subdao = org.akaza.openclinica.core.ApplicationContextProvider.getApplicationContext().getBean(StudySubjectDAO.class);
        ...
        if (studySubId == 0) {
            ...
            /*
             * StudyDAO studydao = org.akaza.openclinica.core.ApplicationContextProvider.getApplicationContext().getBean(StudyDAO.class); StudyBean
            ...
            // find group info
            SubjectGroupMapDAO sgmdao = org.akaza.openclinica.core.ApplicationContextProvider.getApplicationContext().getBean(SubjectGroupMapDAO.class);
            ArrayList groupMaps = (ArrayList) sgmdao.findAllByStudySubject(studySubId);
            request.setAttribute("groups", groupMaps);

            // find audit log for events
            AuditEventDAO aedao = org.akaza.openclinica.core.ApplicationContextProvider.getApplicationContext().getBean(AuditEventDAO.class);
     ...
     * eventDefinitionCRFs) { CRFDAO cdao = org.akaza.openclinica.core.ApplicationContextProvider.getApplicationContext().getBean(CRFDAO.class);
     * CRFVersionDAO vdao = org.akaza.openclinica.core.ApplicationContextProvider.getApplicationContext().getBean(CRFVersionDAO.class); HashMap
