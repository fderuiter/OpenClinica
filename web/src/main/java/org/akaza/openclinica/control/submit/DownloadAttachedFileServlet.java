        ...
        if (fileName != null && fileName.length() > 0) {
            ...
            if (temp.exists()) {
                ...
                if (currentStudy.isSite(parentStudyId)) {
                    testName = testPath + ((StudyBean) org.akaza.openclinica.dao.core.DaoBridge.getDao(StudyDAO.class).findByPK(parentStudyId)).getOid() + tail;
                    ...
                    ArrayList<StudyBean> sites = (ArrayList<StudyBean>) org.akaza.openclinica.dao.core.DaoBridge.getDao(StudyDAO.class).findAllByParent(currentStudy.getId());
