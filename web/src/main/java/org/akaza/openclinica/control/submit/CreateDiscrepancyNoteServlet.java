    ...
    protected void processRequest() throws Exception {
        ...
        if (!StringUtils.isBlank(entityType)) {
            if ("itemData".equalsIgnoreCase(entityType)||"itemdata".equalsIgnoreCase(entityType)) {
                ItemBean item = (ItemBean) org.akaza.openclinica.control.SpringServletAccess.getDao(getServletContext(), ItemDAO.class).findByPK(itemId);
                ...
                StudySubjectBean ssub = (StudySubjectBean) org.akaza.openclinica.control.SpringServletAccess.getDao(getServletContext(), StudySubjectDAO.class).findByPK(entityId);
                SubjectBean sub = (SubjectBean)org.akaza.openclinica.control.SpringServletAccess.getDao(getServletContext(), SubjectDAO.class).findByPK(ssub.getSubjectId());
                ...
                SubjectBean sub = (SubjectBean) org.akaza.openclinica.control.SpringServletAccess.getDao(getServletContext(), SubjectDAO.class).findByPK(entityId);
                ...
                StudyEventBean se = (StudyEventBean)org.akaza.openclinica.control.SpringServletAccess.getDao(getServletContext(), StudyEventDAO.class).findByPK(entityId);
                ...
                EventCRFBean ec = (EventCRFBean) org.akaza.openclinica.control.SpringServletAccess.getDao(getServletContext(), EventCRFDAO.class).findByPK(entityId);
                preUserId = ec.getOwnerId();
                if (!StringUtils.isBlank(column)) {
 ...
 //-> catcher                //   FORM_DISCREPANCY_NOTES_NAME
    ...
    private void updateStudySubjectStatus(String entityType, int entityId) {
        if ("itemData".equalsIgnoreCase(entityType)) {
            ...
            EventCRFDAO ecdao = org.akaza.openclinica.control.SpringServletAccess.getDao(getServletContext(), EventCRFDAO.class);
            StudyEventDAO svdao = org.akaza.openclinica.control.SpringServletAccess.getDao(getServletContext(), StudyEventDAO.class);
