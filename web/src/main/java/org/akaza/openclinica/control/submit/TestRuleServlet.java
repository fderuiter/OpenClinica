...
if(item!=null)
    ...
    private ItemDAO getItemDAO() {
        itemDAO = this.itemDAO != null ? itemDAO : org.akaza.openclinica.dao.core.DaoBridge.getDao(ItemDAO.class);
        return itemDAO;
    }

    private ItemFormMetadataDAO getItemFormMetadataDAO() {
        itemFormMetadataDAO = this.itemFormMetadataDAO != null ? itemFormMetadataDAO : org.akaza.openclinica.dao.core.DaoBridge.getDao(ItemFormMetadataDAO.class);
