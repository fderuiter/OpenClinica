...
public class UpdateStudyEventServlet extends SecureController {
    ...
    public void processRequest() throws Exception {
        ...
        EventCRFDAO ecrfdao = org.akaza.openclinica.control.SpringServletAccess.getDao(getServletContext(), EventCRFDAO.class);
        ...
        EventDefinitionCRFDAO edefcrfdao = org.akaza.openclinica.control.SpringServletAccess.getDao(getServletContext(), EventDefinitionCRFDAO.class);
       ...
       //     v.addValidation(INPUT_LOCATION, Validator.NO_BLANKS); Disable validation on location, location can be empty when updating a study event
            ...
            if (!errors.isEmpty()) {
                ...
                // -------------------
                ssdao = org.akaza.openclinica.control.SpringServletAccess.getDao(getServletContext(), StudySubjectDAO.class);
                ...
                RuleSetDAO ruleSetDao = org.akaza.openclinica.control.SpringServletAccess.getDao(getServletContext(), RuleSetDAO.class);
         ...
         //       getRuleSetService().runRulesInBeanProperty(createRuleSet(ssub,sed),currentStudy,ub,request,ssub);
            ...
            DiscrepancyNoteDAO discrepancyNoteDAO = org.akaza.openclinica.control.SpringServletAccess.getDao(getServletContext(), DiscrepancyNoteDAO.class);
