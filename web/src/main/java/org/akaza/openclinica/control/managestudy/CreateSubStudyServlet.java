...
public class CreateSubStudyServlet extends SecureController {
    ...
    @Autowired
    public CreateSubStudyServlet(CRFDAO _cRFDAO, CRFVersionDAO _cRFVersionDAO, EventDefinitionCRFDAO _eventDefinitionCRFDAO, StudyDAO _studyDAO, StudyEventDefinitionDAO _studyEventDefinitionDAO, StudyParameterValueDAO _studyParameterValueDAO) {
...
//                newStudy.getStudyParameterConfig().setInterviewDateDefault(fp.getString("interviewDateDefault"));
 ...
 /*       StudyDAO studyDAO = this._studyDAO;
        ...
        StudyBean parentStudy = (StudyBean) this._studyDAO.findByPK(newSite.getParentStudyId());
...
*/
    ...
    private ArrayList<StudyEventDefinitionBean> createSiteEventDefinitions(StudyBean site, Validator v) throws MalformedURLException {
        ...
        StudyBean parentStudy = (StudyBean) this._studyDAO.findByPK(site.getParentStudyId());
