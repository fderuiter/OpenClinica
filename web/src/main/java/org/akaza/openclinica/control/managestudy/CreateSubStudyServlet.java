...
//                newStudy.getStudyParameterConfig().setInterviewDateDefault(fp.getString("interviewDateDefault"));
 ...
 /*       StudyDAO studyDAO = org.akaza.openclinica.dao.core.DaoBridge.getDao(StudyDAO.class);
        ...
        StudyBean parentStudy = (StudyBean) org.akaza.openclinica.dao.core.DaoBridge.getDao(StudyDAO.class).findByPK(newSite.getParentStudyId());
...
*/
    ...
    private ArrayList<StudyEventDefinitionBean> createSiteEventDefinitions(StudyBean site, Validator v) throws MalformedURLException {
        ...
        StudyBean parentStudy = (StudyBean) org.akaza.openclinica.dao.core.DaoBridge.getDao(StudyDAO.class).findByPK(site.getParentStudyId());
