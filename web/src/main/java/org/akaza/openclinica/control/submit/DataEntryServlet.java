...
public abstract class DataEntryServlet extends CoreSecureController {
    ...
    protected  void processRequest(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        dndao = org.akaza.openclinica.core.ApplicationContextProvider.getApplicationContext().getBean(DiscrepancyNoteDAO.class);
...
//                }
      ...
      ItemDataDAO iddao = org.akaza.openclinica.core.ApplicationContextProvider.getApplicationContext().getBean(ItemDataDAO.class);
       // ALL_SECTION_BEANS
        ...
        for (int j = 0; j < allSectionBeans.size(); j++) {
           ...
           ItemDAO idao = org.akaza.openclinica.core.ApplicationContextProvider.getApplicationContext().getBean(ItemDAO.class);
           ItemFormMetadataDAO ifmdao = org.akaza.openclinica.core.ApplicationContextProvider.getApplicationContext().getBean(ItemFormMetadataDAO.class);
            iddao = org.akaza.openclinica.core.ApplicationContextProvider.getApplicationContext().getBean(ItemDataDAO.class);
   ...
   long t = System.currentTimeMillis();
    ...
    private DisplayItemBean setTotals(DisplayItemBean dib,int itemDataId,ArrayList<DiscrepancyNoteBean> notes, int ecbId)
    {
        ...
        AuditDAO adao = org.akaza.openclinica.core.ApplicationContextProvider.getApplicationContext().getBean(AuditDAO.class);
   ...
   protected boolean markCRFComplete(HttpServletRequest request) throws Exception {
    ...
    protected boolean isEachRequiredFieldFillout(HttpServletRequest request) {
        ...
        ItemDataDAO iddao = org.akaza.openclinica.core.ApplicationContextProvider.getApplicationContext().getBean(ItemDataDAO.class);
        ItemDAO idao = org.akaza.openclinica.core.ApplicationContextProvider.getApplicationContext().getBean(ItemDAO.class);
        ItemFormMetadataDAO itemFormMetadataDao = org.akaza.openclinica.core.ApplicationContextProvider.getApplicationContext().getBean(ItemFormMetadataDAO.class);
...
//
    ...
    public void mayAccess(HttpServletRequest request) throws InsufficientPermissionException {
        FormProcessor fp = new FormProcessor(request);
        EventCRFDAO edao = org.akaza.openclinica.core.ApplicationContextProvider.getApplicationContext().getBean(EventCRFDAO.class);
        UserAccountBean ub =(UserAccountBean) request.getSession().getAttribute(USER_BEAN_NAME);
