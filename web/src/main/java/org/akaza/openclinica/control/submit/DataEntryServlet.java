...
public abstract class DataEntryServlet extends CoreSecureController {
    ...
    protected  void processRequest(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        dndao = org.akaza.openclinica.dao.core.DaoBridge.getDao(DiscrepancyNoteDAO.class);
...
//                }
    ...
    protected DisplaySectionBean getDisplayBean(boolean hasGroup, boolean includeUngroupedItems, HttpServletRequest request, boolean isSubmitted) throws Exception {
       ...
       SectionDAO sdao;
        ...
        sdao = org.akaza.openclinica.dao.core.DaoBridge.getDao(SectionDAO.class);
     //
      ...
      ItemDataDAO iddao = org.akaza.openclinica.dao.core.DaoBridge.getDao(ItemDataDAO.class);
       // ALL_SECTION_BEANS
        ...
        for (int j = 0; j < allSectionBeans.size(); j++) {
           ...
           ItemDAO idao = org.akaza.openclinica.dao.core.DaoBridge.getDao(ItemDAO.class);
           ItemFormMetadataDAO ifmdao = org.akaza.openclinica.dao.core.DaoBridge.getDao(ItemFormMetadataDAO.class);
            iddao = org.akaza.openclinica.dao.core.DaoBridge.getDao(ItemDataDAO.class);
   ...
   protected boolean markCRFComplete(HttpServletRequest request) throws Exception {
    ...
    protected boolean isEachRequiredFieldFillout(HttpServletRequest request) {
        ...
        ItemDataDAO iddao = org.akaza.openclinica.dao.core.DaoBridge.getDao(ItemDataDAO.class);
        ItemDAO idao = org.akaza.openclinica.dao.core.DaoBridge.getDao(ItemDAO.class);
        ItemFormMetadataDAO itemFormMetadataDao = org.akaza.openclinica.dao.core.DaoBridge.getDao(ItemFormMetadataDAO.class);
...
//
    ...
    public void mayAccess(HttpServletRequest request) throws InsufficientPermissionException {
        FormProcessor fp = new FormProcessor(request);
        EventCRFDAO edao = org.akaza.openclinica.dao.core.DaoBridge.getDao(EventCRFDAO.class);
        UserAccountBean ub =(UserAccountBean) request.getSession().getAttribute(USER_BEAN_NAME);
